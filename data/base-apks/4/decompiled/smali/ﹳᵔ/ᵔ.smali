.class public final Lﹳᵔ/ᵔ;
.super Lcom/google/crypto/tink/shaded/protobuf/ﾞˊ;
.source "SourceFile"


# static fields
.field private static final DEFAULT_INSTANCE:Lﹳᵔ/ᵔ;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lﹳᵔ/ᵔ;

    invoke-direct {v0}, Lcom/google/crypto/tink/shaded/protobuf/ﾞˊ;-><init>()V

    sput-object v0, Lﹳᵔ/ᵔ;->DEFAULT_INSTANCE:Lﹳᵔ/ᵔ;

    const-class v1, Lﹳᵔ/ᵔ;
...
.method public static ˈٴ()Lﹳᵔ/ᵔ;
    .locals 1

    sget-object v0, Lﹳᵔ/ᵔ;->DEFAULT_INSTANCE:Lﹳᵔ/ᵔ;

    return-object v0
.end method

.method public static ˎˑ()Lﹳᵔ/ᵔٴ;
    .locals 1
    ...
    check-cast v0, Lﹳᵔ/ᵔٴ;

    return-object v0
.end method

.method public static יʻ(Lﹳᵔ/ᵔ;Lﹳᵔ/ˑⁱ;)V
    .locals 0

    invoke-virtual {p0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-virtual {p1}, Lﹳᵔ/ˑⁱ;->ـﹶ()I

    move-result p1

    iput p1, p0, Lﹳᵔ/ᵔ;->hash_:I

    return-void
.end method

.method public static ﹳˑ(Lﹳᵔ/ᵔ;I)V
    .locals 0

    iput p1, p0, Lﹳᵔ/ᵔ;->tagSize_:I
...
.method public final ˏʾ(I)Ljava/lang/Object;
    ...
    :pswitch_0
    sget-object p1, Lﹳᵔ/ᵔ;->PARSER:Lcom/google/crypto/tink/shaded/protobuf/ᵔ;

    if-nez p1, :cond_1

    const-class v0, Lﹳᵔ/ᵔ;
    ...
    sput-object p1, Lﹳᵔ/ᵔ;->PARSER:Lcom/google/crypto/tink/shaded/protobuf/ᵔ;
    ...
    :pswitch_1
    sget-object p1, Lﹳᵔ/ᵔ;->DEFAULT_INSTANCE:Lﹳᵔ/ᵔ;

    return-object p1

    :pswitch_2
    new-instance p1, Lﹳᵔ/ᵔٴ;
    ...
    sget-object v1, Lﹳᵔ/ᵔ;->DEFAULT_INSTANCE:Lﹳᵔ/ᵔ;
...
.method public final ᐧⁱ()Lﹳᵔ/ˑⁱ;
    .locals 2

    iget v0, p0, Lﹳᵔ/ᵔ;->hash_:I
    ...
    :cond_0
    sget-object v0, Lﹳᵔ/ˑⁱ;->ﹳﹶ:Lﹳᵔ/ˑⁱ;

    goto :goto_0

    :cond_1
    sget-object v0, Lﹳᵔ/ˑⁱ;->ᵢʿ:Lﹳᵔ/ˑⁱ;

    goto :goto_0

    :cond_2
    sget-object v0, Lﹳᵔ/ˑⁱ;->ˆᵔ:Lﹳᵔ/ˑⁱ;

    goto :goto_0

    :cond_3
    sget-object v0, Lﹳᵔ/ˑⁱ;->ᐧˋ:Lﹳᵔ/ˑⁱ;

    goto :goto_0

    :cond_4
    sget-object v0, Lﹳᵔ/ˑⁱ;->ˎˑ:Lﹳᵔ/ˑⁱ;

    goto :goto_0

    :cond_5
    sget-object v0, Lﹳᵔ/ˑⁱ;->ˆʿ:Lﹳᵔ/ˑⁱ;
