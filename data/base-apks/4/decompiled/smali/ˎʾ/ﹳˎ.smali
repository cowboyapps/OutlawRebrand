...
.field public static volatile ˏᵢ:Lˎʾ/ﹳˎ;

.field public static final ٴˎ:Z

.field public static final ᐧʻ:Ljava/io/File;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lˎʾ/ﹳˎ;->ᐧʻ:Ljava/io/File;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lˎʾ/ﹳˎ;->ˑʽ:Z
    ...
    iput-object v0, p0, Lˎʾ/ﹳˎ;->ﹳﹳ:Ljava/util/concurrent/atomic/AtomicBoolean;

    const/16 v0, 0x4e20

    iput v0, p0, Lˎʾ/ﹳˎ;->ـﹶ:I

    return-void
.end method

.method public static ـﹶ()Lˎʾ/ﹳˎ;
    .locals 2

    sget-object v0, Lˎʾ/ﹳˎ;->ˏᵢ:Lˎʾ/ﹳˎ;

    if-nez v0, :cond_1

    const-class v0, Lˎʾ/ﹳˎ;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lˎʾ/ﹳˎ;->ˏᵢ:Lˎʾ/ﹳˎ;

    if-nez v1, :cond_0

    new-instance v1, Lˎʾ/ﹳˎ;

    invoke-direct {v1}, Lˎʾ/ﹳˎ;-><init>()V

    sput-object v1, Lˎʾ/ﹳˎ;->ˏᵢ:Lˎʾ/ﹳˎ;
...
.method public final ʽᐧ()I
    ...
    :goto_0
    iget v1, v0, Lˎʾ/ﹳˎ;->ـﹶ:I

    return v1
.end method

.method public final ˑʽ(IIZZ)Z
    .locals 6
    ...
    :cond_3
    sget-boolean p3, Lˎʾ/ﹳˎ;->ʿʼ:Z

    if-eqz p3, :cond_5

    iget-object p3, p0, Lˎʾ/ﹳˎ;->ﹳﹳ:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :try_start_0
    iget p2, p0, Lˎʾ/ﹳˎ;->ʽᐧ:I

    const/4 p3, 0x1

    add-int/2addr p2, p3

    iput p2, p0, Lˎʾ/ﹳˎ;->ʽᐧ:I

    const/16 p4, 0x32

    if-lt p2, p4, :cond_a

    iput v1, p0, Lˎʾ/ﹳˎ;->ʽᐧ:I

    sget-object p2, Lˎʾ/ﹳˎ;->ᐧʻ:Ljava/io/File;
    ...
    :goto_0
    iput-boolean p4, p0, Lˎʾ/ﹳˎ;->ˑʽ:Z
    ...
    :cond_a
    :goto_1
    iget-boolean p1, p0, Lˎʾ/ﹳˎ;->ˑʽ:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
