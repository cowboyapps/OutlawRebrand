.class public final Lar/tvplayer/core/data/api/stalker/WatchdogResponseJsonAdapter;
.super Lﹶᵔ/ˉⁱ;
.source "SourceFile"
...
.method public constructor <init>(Lﹶᵔ/יʻ;)V
    ...
    iput-object v1, p0, Lar/tvplayer/core/data/api/stalker/WatchdogResponseJsonAdapter;->ـﹶ:Lᴵﹳ/ʿˏ;

    sget-object v1, Lʻי/ˋˊ;->ᐧⁱ:Lʻי/ˋˊ;

    const-class v2, Lar/tvplayer/core/data/api/stalker/WatchdogResponseJs;

    invoke-virtual {p1, v2, v1, v0}, Lﹶᵔ/יʻ;->ˑʽ(Ljava/lang/reflect/Type;Ljava/util/Set;Ljava/lang/String;)Lﹶᵔ/ˉⁱ;

    move-result-object p1

    iput-object p1, p0, Lar/tvplayer/core/data/api/stalker/WatchdogResponseJsonAdapter;->ʽᐧ:Lﹶᵔ/ˉⁱ;
...
.method public final toString()Ljava/lang/String;
    ...
    const-string v1, "GeneratedJsonAdapter(WatchdogResponse)"
...
.method public final ʽᐧ(Lﹶᵔ/ˏᴵ;)Ljava/lang/Object;
    ...
    iget-object v1, p0, Lar/tvplayer/core/data/api/stalker/WatchdogResponseJsonAdapter;->ـﹶ:Lᴵﹳ/ʿˏ;
    ...
    :cond_0
    iget-object v0, p0, Lar/tvplayer/core/data/api/stalker/WatchdogResponseJsonAdapter;->ʽᐧ:Lﹶᵔ/ˉⁱ;

    invoke-virtual {v0, p1}, Lﹶᵔ/ˉⁱ;->ʽᐧ(Lﹶᵔ/ˏᴵ;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lar/tvplayer/core/data/api/stalker/WatchdogResponseJs;
    ...
    new-instance v1, Lar/tvplayer/core/data/api/stalker/WatchdogResponse;

    if-eqz v0, :cond_4

    invoke-direct {v1, v0}, Lar/tvplayer/core/data/api/stalker/WatchdogResponse;-><init>(Lar/tvplayer/core/data/api/stalker/WatchdogResponseJs;)V
...
.method public final ʿʼ(Lﹶᵔ/ˎٴ;Ljava/lang/Object;)V
    ...
    check-cast p2, Lar/tvplayer/core/data/api/stalker/WatchdogResponse;
    ...
    iget-object p2, p2, Lar/tvplayer/core/data/api/stalker/WatchdogResponse;->ـﹶ:Lar/tvplayer/core/data/api/stalker/WatchdogResponseJs;
