.class public final Lar/tvplayer/core/data/api/stalker/VodGenreJsonAdapter;
.super Lﹶᵔ/ˉⁱ;
.source "SourceFile"
...
.method public constructor <init>(Lﹶᵔ/יʻ;)V
    ...
    iput-object v2, p0, Lar/tvplayer/core/data/api/stalker/VodGenreJsonAdapter;->ـﹶ:Lᴵﹳ/ʿˏ;

    sget-object v2, Lʻי/ˋˊ;->ᐧⁱ:Lʻי/ˋˊ;

    const-class v3, Ljava/lang/String;

    invoke-virtual {p1, v3, v2, v0}, Lﹶᵔ/יʻ;->ˑʽ(Ljava/lang/reflect/Type;Ljava/util/Set;Ljava/lang/String;)Lﹶᵔ/ˉⁱ;

    move-result-object v0

    iput-object v0, p0, Lar/tvplayer/core/data/api/stalker/VodGenreJsonAdapter;->ʽᐧ:Lﹶᵔ/ˉⁱ;
    ...
    iput-object p1, p0, Lar/tvplayer/core/data/api/stalker/VodGenreJsonAdapter;->ˑʽ:Lﹶᵔ/ˉⁱ;
...
.method public final toString()Ljava/lang/String;
    ...
    const-string v1, "GeneratedJsonAdapter(VodGenre)"
...
.method public final ʽᐧ(Lﹶᵔ/ˏᴵ;)Ljava/lang/Object;
    ...
    iget-object v2, p0, Lar/tvplayer/core/data/api/stalker/VodGenreJsonAdapter;->ـﹶ:Lᴵﹳ/ʿˏ;
    ...
    :cond_0
    iget-object v1, p0, Lar/tvplayer/core/data/api/stalker/VodGenreJsonAdapter;->ˑʽ:Lﹶᵔ/ˉⁱ;
    ...
    :cond_1
    iget-object v0, p0, Lar/tvplayer/core/data/api/stalker/VodGenreJsonAdapter;->ʽᐧ:Lﹶᵔ/ˉⁱ;
    ...
    new-instance v2, Lar/tvplayer/core/data/api/stalker/VodGenre;

    if-eqz v0, :cond_5

    invoke-direct {v2, v0, v1}, Lar/tvplayer/core/data/api/stalker/VodGenre;-><init>(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final ʿʼ(Lﹶᵔ/ˎٴ;Ljava/lang/Object;)V
    ...
    check-cast p2, Lar/tvplayer/core/data/api/stalker/VodGenre;
    ...
    iget-object v1, p2, Lar/tvplayer/core/data/api/stalker/VodGenre;->ـﹶ:Ljava/lang/String;
    ...
    iget-object v0, p0, Lar/tvplayer/core/data/api/stalker/VodGenreJsonAdapter;->ˑʽ:Lﹶᵔ/ˉⁱ;

    iget-object p2, p2, Lar/tvplayer/core/data/api/stalker/VodGenre;->ʽᐧ:Ljava/lang/String;
