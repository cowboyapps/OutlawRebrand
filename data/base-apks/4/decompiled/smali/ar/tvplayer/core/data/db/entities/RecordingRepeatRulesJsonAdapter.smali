.class public final Lar/tvplayer/core/data/db/entities/RecordingRepeatRulesJsonAdapter;
.super Lﹶᵔ/ˉⁱ;
.source "SourceFile"
...
.method public constructor <init>(Lﹶᵔ/יʻ;)V
    ...
    iput-object v0, p0, Lar/tvplayer/core/data/db/entities/RecordingRepeatRulesJsonAdapter;->ـﹶ:Lᴵﹳ/ʿˏ;

    sget-object v0, Lʻי/ˋˊ;->ᐧⁱ:Lʻי/ˋˊ;

    const-string v1, "daysStr"
    ...
    iput-object p1, p0, Lar/tvplayer/core/data/db/entities/RecordingRepeatRulesJsonAdapter;->ʽᐧ:Lﹶᵔ/ˉⁱ;
...
.method public final toString()Ljava/lang/String;
    ...
    const-string v1, "GeneratedJsonAdapter(RecordingRepeatRules)"
...
.method public final ʽᐧ(Lﹶᵔ/ˏᴵ;)Ljava/lang/Object;
    ...
    const-string v3, "daysStr"

    if-eqz v1, :cond_3

    iget-object v1, p0, Lar/tvplayer/core/data/db/entities/RecordingRepeatRulesJsonAdapter;->ـﹶ:Lᴵﹳ/ʿˏ;
    ...
    :cond_0
    iget-object v0, p0, Lar/tvplayer/core/data/db/entities/RecordingRepeatRulesJsonAdapter;->ʽᐧ:Lﹶᵔ/ˉⁱ;
    ...
    new-instance v1, Lar/tvplayer/core/data/db/entities/RecordingRepeatRules;

    if-eqz v0, :cond_4

    invoke-direct {v1, v0}, Lar/tvplayer/core/data/db/entities/RecordingRepeatRules;-><init>(Ljava/lang/String;)V
...
.method public final ʿʼ(Lﹶᵔ/ˎٴ;Ljava/lang/Object;)V
    ...
    check-cast p2, Lar/tvplayer/core/data/db/entities/RecordingRepeatRules;
    ...
    iget-object p2, p2, Lar/tvplayer/core/data/db/entities/RecordingRepeatRules;->ـﹶ:Ljava/lang/String;
