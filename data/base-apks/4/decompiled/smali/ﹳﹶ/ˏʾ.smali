.class public final Lﹳﹶ/ˏʾ;
.super Lʼˉ/ٴˎ;
.source "SourceFile"


# direct methods
.method public static ˆᵔ(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    .locals 2
...
.method public static ˎˑ(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
    .locals 5
    ...
    invoke-static {v0, v1}, Lﹳﹶ/ˏʾ;->ˆᵔ(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    ...
    invoke-static {v0, v4}, Lﹳﹶ/ˏʾ;->ˆᵔ(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
...
.method public static ᐧˋ([Lʾʼ/ˉי;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    .locals 8
    ...
    :try_start_0
    iget-object v5, v4, Lʾʼ/ˉי;->ـﹶ:Landroid/net/Uri;
    ...
    iget v7, v4, Lʾʼ/ˉי;->ˑʽ:I

    invoke-virtual {v6, v7}, Landroid/graphics/fonts/Font$Builder;->setWeight(I)Landroid/graphics/fonts/Font$Builder;

    move-result-object v6

    iget-boolean v7, v4, Lʾʼ/ˉי;->ﹳﹳ:Z

    invoke-virtual {v6, v7}, Landroid/graphics/fonts/Font$Builder;->setSlant(I)Landroid/graphics/fonts/Font$Builder;

    move-result-object v6

    iget v4, v4, Lʾʼ/ˉי;->ʽᐧ:I
...
.method public final ʿʼ(Landroid/content/Context;Lᵢʿ/ʿʼ;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    invoke-static {p2, p4}, Lﹳﹶ/ˏʾ;->ˎˑ(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final ˉⁱ([Lʾʼ/ˉי;I)Lʾʼ/ˉי;
    .locals 0
...
.method public final ˏᵢ(Landroid/content/Context;Ljava/io/InputStream;)Landroid/graphics/Typeface;
    .locals 0
...
.method public final ٴˎ(Landroid/content/Context;[Lʾʼ/ˉי;I)Landroid/graphics/Typeface;
    ...
    :try_start_0
    invoke-static {p2, p1}, Lﹳﹶ/ˏʾ;->ᐧˋ([Lʾʼ/ˉי;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    invoke-static {p1, p3}, Lﹳﹶ/ˏʾ;->ˎˑ(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final ᐧʻ(Landroid/content/Context;Ljava/util/List;I)Landroid/graphics/Typeface;
    .locals 5
    ...
    invoke-static {v0, p1}, Lﹳﹶ/ˏʾ;->ᐧˋ([Lʾʼ/ˉי;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    check-cast v4, [Lʾʼ/ˉי;

    invoke-static {v4, p1}, Lﹳﹶ/ˏʾ;->ᐧˋ([Lʾʼ/ˉי;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    :cond_2
    invoke-static {v0, p3}, Lﹳﹶ/ˏʾ;->ˎˑ(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
