...
.method static C(Lj$/time/chrono/k;Lj$/time/temporal/Temporal;)Lj$/time/chrono/j;
    .locals 3
...
.method static S(Lj$/time/ZoneId;Lj$/time/ZoneOffset;Lj$/time/chrono/e;)Lj$/time/chrono/ChronoZonedDateTime;
    .locals 6
    ...
    invoke-virtual {p1}, Lj$/time/zone/b;->r()Lj$/time/e;
    ...
    invoke-virtual {p2, v0, v1}, Lj$/time/chrono/e;->V(J)Lj$/time/chrono/e;
...
.method static T(Lj$/time/chrono/k;Lj$/time/Instant;Lj$/time/ZoneId;)Lj$/time/chrono/j;
    .locals 3
...
.method public final synthetic A(Lj$/time/temporal/r;)Ljava/lang/Object;
    ...
    invoke-static {p0, p1}, Lj$/time/chrono/g;->l(Lj$/time/chrono/ChronoZonedDateTime;Lj$/time/temporal/r;)Ljava/lang/Object;
...
.method public final F()Lj$/time/chrono/ChronoLocalDateTime;
    .locals 1
...
.method public final U(JLj$/time/temporal/TemporalUnit;)Lj$/time/chrono/ChronoZonedDateTime;
    .locals 1
    ...
    invoke-virtual {v0, p1, p2, p3}, Lj$/time/chrono/e;->U(JLj$/time/temporal/TemporalUnit;)Lj$/time/chrono/e;
    ...
    invoke-virtual {p1, p0}, Lj$/time/chrono/e;->C(Lj$/time/temporal/Temporal;)Lj$/time/temporal/Temporal;

    move-result-object p1

    invoke-static {p2, p1}, Lj$/time/chrono/j;->C(Lj$/time/chrono/k;Lj$/time/temporal/Temporal;)Lj$/time/chrono/j;
    ...
    invoke-static {v0, p1}, Lj$/time/chrono/j;->C(Lj$/time/chrono/k;Lj$/time/temporal/Temporal;)Lj$/time/chrono/j;
...
.method public final b()Lj$/time/k;
    ...
    invoke-virtual {p0}, Lj$/time/chrono/j;->F()Lj$/time/chrono/ChronoLocalDateTime;

    move-result-object v0

    check-cast v0, Lj$/time/chrono/e;

    invoke-virtual {v0}, Lj$/time/chrono/e;->b()Lj$/time/k;
...
.method public final d(JLj$/time/temporal/q;)Lj$/time/temporal/Temporal;
    ...
    invoke-virtual {v4, p1, p2, p3}, Lj$/time/chrono/e;->Y(JLj$/time/temporal/q;)Lj$/time/chrono/e;

    move-result-object p1

    iget-object p2, p0, Lj$/time/chrono/j;->b:Lj$/time/ZoneOffset;

    invoke-static {v3, p2, p1}, Lj$/time/chrono/j;->S(Lj$/time/ZoneId;Lj$/time/ZoneOffset;Lj$/time/chrono/e;)Lj$/time/chrono/ChronoZonedDateTime;
    ...
    invoke-virtual {v4, p1}, Lj$/time/chrono/e;->X(Lj$/time/ZoneOffset;)Lj$/time/Instant;
    ...
    invoke-static {p2, p1, v3}, Lj$/time/chrono/j;->T(Lj$/time/chrono/k;Lj$/time/Instant;Lj$/time/ZoneId;)Lj$/time/chrono/j;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lj$/time/chrono/j;->U(JLj$/time/temporal/TemporalUnit;)Lj$/time/chrono/ChronoZonedDateTime;
...
.method public final i(Lj$/time/ZoneId;)Lj$/time/chrono/ChronoZonedDateTime;
    ...
    invoke-virtual {v0, v1}, Lj$/time/chrono/e;->X(Lj$/time/ZoneOffset;)Lj$/time/Instant;
    ...
    invoke-static {v1, v0, p1}, Lj$/time/chrono/j;->T(Lj$/time/chrono/k;Lj$/time/Instant;Lj$/time/ZoneId;)Lj$/time/chrono/j;
...
.method public final j(Lj$/time/ZoneId;)Lj$/time/chrono/ChronoZonedDateTime;
    ...
    invoke-static {p1, v1, v0}, Lj$/time/chrono/j;->S(Lj$/time/ZoneId;Lj$/time/ZoneOffset;Lj$/time/chrono/e;)Lj$/time/chrono/ChronoZonedDateTime;
...
.method public final synthetic p(Lj$/time/temporal/q;)I
    ...
    invoke-static {p0, p1}, Lj$/time/chrono/g;->e(Lj$/time/chrono/ChronoZonedDateTime;Lj$/time/temporal/q;)I
...
.method public final r(Lj$/time/LocalDate;)Lj$/time/temporal/Temporal;
    ...
    invoke-virtual {p1, p0}, Lj$/time/LocalDate;->C(Lj$/time/temporal/Temporal;)Lj$/time/temporal/Temporal;
...
.method public final s(Lj$/time/temporal/q;)Lj$/time/temporal/t;
    ...
    invoke-virtual {v0, p1}, Lj$/time/chrono/e;->s(Lj$/time/temporal/q;)Lj$/time/temporal/t;
...
.method public final toInstant()Lj$/time/Instant;
    ...
    invoke-virtual {p0}, Lj$/time/chrono/j;->b()Lj$/time/k;
...
.method public final v(Lj$/time/temporal/q;)J
    ...
    invoke-virtual {v0, p1}, Lj$/time/chrono/e;->v(Lj$/time/temporal/q;)J
    ...
    :cond_0
    invoke-virtual {p0}, Lj$/time/chrono/j;->h()Lj$/time/ZoneOffset;
