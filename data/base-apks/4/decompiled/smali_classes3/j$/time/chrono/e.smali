...
# direct methods
.method private constructor <init>(Lj$/time/chrono/ChronoLocalDate;Lj$/time/k;)V
    .locals 1
    ...
    iput-object p2, p0, Lj$/time/chrono/e;->b:Lj$/time/k;

    return-void
.end method

.method static S(Lj$/time/chrono/k;Lj$/time/temporal/Temporal;)Lj$/time/chrono/e;
    .locals 3
...
.method static T(Lj$/time/chrono/ChronoLocalDate;Lj$/time/k;)Lj$/time/chrono/e;
    .locals 1

    new-instance v0, Lj$/time/chrono/e;

    invoke-direct {v0, p0, p1}, Lj$/time/chrono/e;-><init>(Lj$/time/chrono/ChronoLocalDate;Lj$/time/k;)V

    return-object v0
.end method

.method private W(Lj$/time/chrono/ChronoLocalDate;JJJJ)Lj$/time/chrono/e;
    .locals 17
    ...
    iget-object v6, v0, Lj$/time/chrono/e;->b:Lj$/time/k;

    cmp-long v7, v2, v4

    if-nez v7, :cond_0

    invoke-direct {v0, v1, v6}, Lj$/time/chrono/e;->Z(Lj$/time/temporal/Temporal;Lj$/time/k;)Lj$/time/chrono/e;
...
.method private Z(Lj$/time/temporal/Temporal;Lj$/time/k;)Lj$/time/chrono/e;
    .locals 2
    ...
    iget-object v1, p0, Lj$/time/chrono/e;->b:Lj$/time/k;
    ...
    invoke-direct {v0, p1, p2}, Lj$/time/chrono/e;-><init>(Lj$/time/chrono/ChronoLocalDate;Lj$/time/k;)V
...
.method public final C(Lj$/time/temporal/Temporal;)Lj$/time/temporal/Temporal;
    ...
    invoke-virtual {p0}, Lj$/time/chrono/e;->b()Lj$/time/k;
...
.method public final synthetic E(Lj$/time/chrono/ChronoLocalDateTime;)I
    .locals 0
...
.method public final U(JLj$/time/temporal/TemporalUnit;)Lj$/time/chrono/e;
    .locals 21
    ...
    iget-object v3, v10, Lj$/time/chrono/e;->b:Lj$/time/k;
    ...
    invoke-direct {v10, v0, v3}, Lj$/time/chrono/e;->Z(Lj$/time/temporal/Temporal;Lj$/time/k;)Lj$/time/chrono/e;
    ...
    invoke-direct {v10, v2, v3}, Lj$/time/chrono/e;->Z(Lj$/time/temporal/Temporal;Lj$/time/k;)Lj$/time/chrono/e;
    ...
    invoke-direct/range {v11 .. v20}, Lj$/time/chrono/e;->W(Lj$/time/chrono/ChronoLocalDate;JJJJ)Lj$/time/chrono/e;
    ...
    invoke-direct/range {v0 .. v9}, Lj$/time/chrono/e;->W(Lj$/time/chrono/ChronoLocalDate;JJJJ)Lj$/time/chrono/e;
    ...
    :pswitch_3
    invoke-virtual/range {p0 .. p2}, Lj$/time/chrono/e;->V(J)Lj$/time/chrono/e;
    ...
    invoke-static {v1, v0}, Lj$/time/chrono/e;->S(Lj$/time/chrono/k;Lj$/time/temporal/Temporal;)Lj$/time/chrono/e;
...
.method final V(J)Lj$/time/chrono/e;
    .locals 10
...
.method public final X(Lj$/time/ZoneOffset;)Lj$/time/Instant;
    ...
    iget-object p1, p0, Lj$/time/chrono/e;->b:Lj$/time/k;

    invoke-virtual {p1}, Lj$/time/k;->Y()I
...
.method public final Y(JLj$/time/temporal/q;)Lj$/time/chrono/e;
    .locals 3
    ...
    iget-object v2, p0, Lj$/time/chrono/e;->b:Lj$/time/k;

    if-eqz v0, :cond_0

    invoke-virtual {v2, p1, p2, p3}, Lj$/time/k;->m0(JLj$/time/temporal/q;)Lj$/time/k;

    move-result-object p1

    invoke-direct {p0, v1, p1}, Lj$/time/chrono/e;->Z(Lj$/time/temporal/Temporal;Lj$/time/k;)Lj$/time/chrono/e;
    ...
    :cond_0
    invoke-interface {v1, p1, p2, p3}, Lj$/time/chrono/ChronoLocalDate;->d(JLj$/time/temporal/q;)Lj$/time/chrono/ChronoLocalDate;

    move-result-object p1

    invoke-direct {p0, p1, v2}, Lj$/time/chrono/e;->Z(Lj$/time/temporal/Temporal;Lj$/time/k;)Lj$/time/chrono/e;
    ...
    invoke-static {v0, p1}, Lj$/time/chrono/e;->S(Lj$/time/chrono/k;Lj$/time/temporal/Temporal;)Lj$/time/chrono/e;
...
.method public final b()Lj$/time/k;
    ...
    iget-object v0, p0, Lj$/time/chrono/e;->b:Lj$/time/k;
...
.method public final bridge synthetic compareTo(Ljava/lang/Object;)I
    ...
    invoke-virtual {p0, p1}, Lj$/time/chrono/e;->E(Lj$/time/chrono/ChronoLocalDateTime;)I
...
.method public final bridge synthetic d(JLj$/time/temporal/q;)Lj$/time/temporal/Temporal;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lj$/time/chrono/e;->Y(JLj$/time/temporal/q;)Lj$/time/chrono/e;
...
.method public final bridge synthetic e(JLj$/time/temporal/TemporalUnit;)Lj$/time/temporal/Temporal;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lj$/time/chrono/e;->U(JLj$/time/temporal/TemporalUnit;)Lj$/time/chrono/e;
...
.method public final o(Lj$/time/ZoneId;)Lj$/time/chrono/ChronoZonedDateTime;
    ...
    invoke-static {p1, v0, p0}, Lj$/time/chrono/j;->S(Lj$/time/ZoneId;Lj$/time/ZoneOffset;Lj$/time/chrono/e;)Lj$/time/chrono/ChronoZonedDateTime;
...
.method public final p(Lj$/time/temporal/q;)I
    ...
    invoke-interface {v0, p1}, Lj$/time/temporal/TemporalAccessor;->p(Lj$/time/temporal/q;)I
    ...
    :cond_1
    invoke-virtual {p0, p1}, Lj$/time/chrono/e;->s(Lj$/time/temporal/q;)Lj$/time/temporal/t;

    move-result-object v0

    invoke-virtual {p0, p1}, Lj$/time/chrono/e;->v(Lj$/time/temporal/q;)J

    move-result-wide v1

    invoke-virtual {v0, v1, v2, p1}, Lj$/time/temporal/t;->a(JLj$/time/temporal/q;)I
...
.method public final r(Lj$/time/LocalDate;)Lj$/time/temporal/Temporal;
    ...
    invoke-direct {p0, p1, v0}, Lj$/time/chrono/e;->Z(Lj$/time/temporal/Temporal;Lj$/time/k;)Lj$/time/chrono/e;
...
.method public final s(Lj$/time/temporal/q;)Lj$/time/temporal/t;
    ...
    invoke-interface {v0, p1}, Lj$/time/temporal/TemporalAccessor;->s(Lj$/time/temporal/q;)Lj$/time/temporal/t;
...
.method public final until(Lj$/time/temporal/Temporal;Lj$/time/temporal/TemporalUnit;)J
    ...
    invoke-interface {v1, p1}, Lj$/time/chrono/k;->B(Lj$/time/temporal/Temporal;)Lj$/time/chrono/ChronoLocalDateTime;
    ...
    :goto_0
    iget-object v3, p0, Lj$/time/chrono/e;->b:Lj$/time/k;
    ...
    invoke-static {v4, v5, v0, v1}, Lj$/com/android/tools/r8/a;->p(JJ)J
    ...
    invoke-static {v4, v5, p1, p2}, Lj$/com/android/tools/r8/a;->j(JJ)J
    ...
    invoke-interface {v1, v3, v4, v2}, Lj$/time/chrono/ChronoLocalDate;->M(JLj$/time/temporal/TemporalUnit;)Lj$/time/chrono/ChronoLocalDate;

    move-result-object v1

    :cond_2
    invoke-interface {v0, v1, p2}, Lj$/time/chrono/ChronoLocalDate;->until(Lj$/time/temporal/Temporal;Lj$/time/temporal/TemporalUnit;)J
