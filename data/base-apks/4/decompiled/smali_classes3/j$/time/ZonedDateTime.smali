...
.method private static C(JILj$/time/ZoneId;)Lj$/time/ZonedDateTime;
    .locals 3
...
.method public static S(Lj$/time/temporal/Temporal;)Lj$/time/ZonedDateTime;
    .locals 5
    ...
    invoke-interface {p0, v3}, Lj$/time/temporal/TemporalAccessor;->p(Lj$/time/temporal/q;)I

    move-result v3

    invoke-static {v1, v2, v3, v0}, Lj$/time/ZonedDateTime;->C(JILj$/time/ZoneId;)Lj$/time/ZonedDateTime;
    ...
    invoke-static {v1, v2}, Lj$/time/LocalDateTime;->a0(Lj$/time/LocalDate;Lj$/time/k;)Lj$/time/LocalDateTime;
...
.method public static T(Lj$/time/Instant;Lj$/time/ZoneId;)Lj$/time/ZonedDateTime;
    ...
    invoke-static {v0, v1, p0, p1}, Lj$/time/ZonedDateTime;->C(JILj$/time/ZoneId;)Lj$/time/ZonedDateTime;
...
.method public final V(JLj$/time/temporal/TemporalUnit;)Lj$/time/ZonedDateTime;
    ...
    invoke-virtual {v3, p1, p2, p3}, Lj$/time/LocalDateTime;->c0(JLj$/time/temporal/TemporalUnit;)Lj$/time/LocalDateTime;
    ...
    invoke-static {p1, v1}, Lj$/time/chrono/g;->n(Lj$/time/chrono/ChronoLocalDateTime;Lj$/time/ZoneOffset;)J
    ...
    invoke-static {p2, p3, p1, v2}, Lj$/time/ZonedDateTime;->C(JILj$/time/ZoneId;)Lj$/time/ZonedDateTime;
...
.method public final Y(Lj$/time/ZoneId;)Lj$/time/ZonedDateTime;
    ...
    invoke-static {v1, v2, v0, p1}, Lj$/time/ZonedDateTime;->C(JILj$/time/ZoneId;)Lj$/time/ZonedDateTime;
...
.method final Z(Ljava/io/DataOutput;)V
    ...
    invoke-virtual {v0, p1}, Lj$/time/LocalDateTime;->h0(Ljava/io/DataOutput;)V
...
.method public final d(JLj$/time/temporal/q;)Lj$/time/temporal/Temporal;
    ...
    invoke-virtual {v3, p1, p2, p3}, Lj$/time/LocalDateTime;->e0(JLj$/time/temporal/q;)Lj$/time/LocalDateTime;
    ...
    :cond_2
    invoke-virtual {v3}, Lj$/time/LocalDateTime;->U()I

    move-result p3

    invoke-static {p1, p2, p3, v4}, Lj$/time/ZonedDateTime;->C(JILj$/time/ZoneId;)Lj$/time/ZonedDateTime;
...
.method public final bridge synthetic i(Lj$/time/ZoneId;)Lj$/time/chrono/ChronoZonedDateTime;
    .locals 0
...
.method public final n(JLj$/time/temporal/ChronoUnit;)Lj$/time/temporal/Temporal;
    ...
    invoke-virtual {p1, v0, v1, p3}, Lj$/time/ZonedDateTime;->V(JLj$/time/temporal/TemporalUnit;)Lj$/time/ZonedDateTime;
...
.method public final p(Lj$/time/temporal/q;)I
    ...
    invoke-virtual {v0, p1}, Lj$/time/LocalDateTime;->p(Lj$/time/temporal/q;)I
...
.method public final r(Lj$/time/LocalDate;)Lj$/time/temporal/Temporal;
    ...
    invoke-static {p1, v0}, Lj$/time/LocalDateTime;->a0(Lj$/time/LocalDate;Lj$/time/k;)Lj$/time/LocalDateTime;
...
.method public final s(Lj$/time/temporal/q;)Lj$/time/temporal/t;
    ...
    invoke-virtual {v0, p1}, Lj$/time/LocalDateTime;->s(Lj$/time/temporal/q;)Lj$/time/temporal/t;
...
.method public final until(Lj$/time/temporal/Temporal;Lj$/time/temporal/TemporalUnit;)J
    ...
    invoke-static {p1}, Lj$/time/ZonedDateTime;->S(Lj$/time/temporal/Temporal;)Lj$/time/ZonedDateTime;
    ...
    invoke-virtual {v2, v3, p2}, Lj$/time/LocalDateTime;->until(Lj$/time/temporal/Temporal;Lj$/time/temporal/TemporalUnit;)J
    ...
    invoke-static {v2, v0}, Lj$/time/OffsetDateTime;->T(Lj$/time/LocalDateTime;Lj$/time/ZoneOffset;)Lj$/time/OffsetDateTime;

    move-result-object v0

    iget-object p1, p1, Lj$/time/ZonedDateTime;->b:Lj$/time/ZoneOffset;

    invoke-static {v3, p1}, Lj$/time/OffsetDateTime;->T(Lj$/time/LocalDateTime;Lj$/time/ZoneOffset;)Lj$/time/OffsetDateTime;
