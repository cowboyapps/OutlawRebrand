...
.method public final n(Lj$/time/format/z;Ljava/lang/StringBuilder;)Z
    ...
    invoke-virtual {p1, v0}, Lj$/time/format/z;->f(Lj$/time/temporal/r;)Ljava/lang/Object;
    ...
    invoke-interface {v3, v5}, Lj$/time/temporal/TemporalAccessor;->v(Lj$/time/temporal/q;)J

    move-result-wide v8

    invoke-static {v8, v9}, Lj$/time/LocalDate;->g0(J)Lj$/time/LocalDate;

    move-result-object v5

    invoke-interface {v3, v7}, Lj$/time/temporal/TemporalAccessor;->v(Lj$/time/temporal/q;)J

    move-result-wide v7

    invoke-static {v7, v8}, Lj$/time/k;->c0(J)Lj$/time/k;

    move-result-object v3

    invoke-static {v5, v3}, Lj$/time/LocalDateTime;->a0(Lj$/time/LocalDate;Lj$/time/k;)Lj$/time/LocalDateTime;
    ...
    invoke-virtual {v0}, Lj$/time/ZonedDateTime;->b()Lj$/time/k;
    ...
    invoke-static {v7, v8, v9, v10}, Lj$/time/Instant;->W(JJ)Lj$/time/Instant;
