...
.method private constructor <init>([J[Lj$/time/ZoneOffset;[J[Lj$/time/ZoneOffset;[Lj$/time/zone/e;)V
    ...
    invoke-virtual {v2}, Lj$/time/zone/b;->C()Z
...
.method private static a(Lj$/time/LocalDateTime;Lj$/time/zone/b;)Ljava/lang/Object;
    ...
    invoke-virtual {p1}, Lj$/time/zone/b;->C()Z

    move-result v1

    if-eqz v1, :cond_2

    invoke-virtual {p0, v0}, Lj$/time/LocalDateTime;->X(Lj$/time/LocalDateTime;)Z
...
.method private b(I)[Lj$/time/zone/b;
    ...
    invoke-static {v8}, Lj$/time/LocalDateTime;->Y(I)Lj$/time/LocalDateTime;
    ...
    invoke-static {v8, v5}, Lj$/time/chrono/g;->n(Lj$/time/chrono/ChronoLocalDateTime;Lj$/time/ZoneOffset;)J
    ...
    invoke-static {v4, v5, v12, v13}, Lj$/com/android/tools/r8/a;->o(JJ)J
...
.method private static c(JLj$/time/ZoneOffset;)I
    ...
    invoke-virtual {p2}, Lj$/time/ZoneOffset;->a0()I
...
.method private e(Lj$/time/LocalDateTime;)Ljava/lang/Object;
    ...
    invoke-static {p1, v0}, Lj$/time/chrono/g;->n(Lj$/time/chrono/ChronoLocalDateTime;Lj$/time/ZoneOffset;)J
    ...
    invoke-virtual {p1, v1}, Lj$/time/LocalDateTime;->W(Lj$/time/LocalDateTime;)Z
...
.method static k(Ljava/io/ObjectInput;)Lj$/time/zone/f;
    .locals 9
...
.method public final g(Lj$/time/LocalDateTime;)Ljava/util/List;
    ...
    invoke-virtual {p1}, Lj$/time/zone/b;->A()Ljava/util/List;
...
.method public final h(Lj$/time/Instant;)Z
    ...
    invoke-static {v0}, Lj$/time/zone/f;->j(I)Lj$/time/ZoneOffset;
