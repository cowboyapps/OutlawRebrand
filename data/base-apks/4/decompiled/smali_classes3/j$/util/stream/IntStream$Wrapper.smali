...
.method public final synthetic asDoubleStream()Ljava/util/stream/DoubleStream;
    ...
    invoke-static {v0}, Lj$/util/stream/E;->k(Lj$/util/stream/F;)Ljava/util/stream/DoubleStream;
...
.method public final synthetic average()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->average()Lj$/util/A;

    move-result-object v0

    invoke-static {v0}, Lj$/util/b;->n(Lj$/util/A;)Ljava/util/OptionalDouble;
...
.method public final synthetic findAny()Ljava/util/OptionalInt;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->findAny()Lj$/util/B;

    move-result-object v0

    invoke-static {v0}, Lj$/util/b;->o(Lj$/util/B;)Ljava/util/OptionalInt;
...
.method public final synthetic findFirst()Ljava/util/OptionalInt;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->findFirst()Lj$/util/B;
...
.method public final synthetic iterator()Ljava/util/PrimitiveIterator$OfInt;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->iterator()Lj$/util/K;

    move-result-object v0

    invoke-static {v0}, Lj$/util/J;->a(Lj$/util/K;)Ljava/util/PrimitiveIterator$OfInt;
...
.method public final synthetic mapToDouble(Ljava/util/function/IntToDoubleFunction;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {p1}, Lj$/util/stream/IntStream;->f()Lj$/util/stream/F;
...
.method public final synthetic max()Ljava/util/OptionalInt;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->max()Lj$/util/B;
...
.method public final synthetic min()Ljava/util/OptionalInt;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->min()Lj$/util/B;
...
.method public final synthetic reduce(Ljava/util/function/IntBinaryOperator;)Ljava/util/OptionalInt;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/IntStream;->reduce(Ljava/util/function/IntBinaryOperator;)Lj$/util/B;

    move-result-object p1

    invoke-static {p1}, Lj$/util/b;->o(Lj$/util/B;)Ljava/util/OptionalInt;
...
.method public final synthetic spliterator()Ljava/util/Spliterator$OfInt;
    ...
    invoke-static {v0}, Lj$/util/W;->a(Lj$/util/X;)Ljava/util/Spliterator$OfInt;
...
.method public final summaryStatistics()Ljava/util/IntSummaryStatistics;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->summaryStatistics()Lj$/util/x;
