...
.method public final forEachRemaining(Ljava/lang/Object;)V
    ...
    :goto_0
    invoke-virtual {p0}, Lj$/util/stream/F3;->d()Lj$/util/stream/E3;

    move-result-object v1

    sget-object v2, Lj$/util/stream/E3;->NO_MORE:Lj$/util/stream/E3;

    if-eq v1, v2, :cond_5

    sget-object v2, Lj$/util/stream/E3;->MAYBE_MORE:Lj$/util/stream/E3;

    iget-object v3, p0, Lj$/util/stream/F3;->a:Lj$/util/Spliterator;

    if-ne v1, v2, :cond_4

    iget v1, p0, Lj$/util/stream/F3;->c:I

    if-nez v0, :cond_0

    invoke-virtual {p0, v1}, Lj$/util/stream/C3;->h(I)Lj$/util/stream/j3;
    ...
    :cond_3
    invoke-virtual {p0, v6, v7}, Lj$/util/stream/F3;->b(J)J

    move-result-wide v1

    invoke-virtual {v0, p1, v1, v2}, Lj$/util/stream/j3;->b(Ljava/lang/Object;J)V
...
.method protected abstract h(I)Lj$/util/stream/j3;
.end method
...
.method public final tryAdvance(Ljava/lang/Object;)Z
    ...
    sget-object v1, Lj$/util/stream/E3;->NO_MORE:Lj$/util/stream/E3;
    ...
    invoke-virtual {p0, v0, v1}, Lj$/util/stream/F3;->b(J)J
    ...
    invoke-virtual {p0, p1}, Lj$/util/stream/C3;->e(Ljava/lang/Object;)V
