...
.method public static synthetic convert(Lj$/util/stream/Stream;)Ljava/util/stream/Stream;
    ...
    :cond_0
    instance-of v0, p0, Lj$/util/stream/a3;

    if-eqz v0, :cond_1

    check-cast p0, Lj$/util/stream/a3;

    iget-object p0, p0, Lj$/util/stream/a3;->a:Ljava/util/stream/Stream;
...
.method public final synthetic findAny()Ljava/util/Optional;
    ...
    invoke-static {v0}, Lj$/util/b;->m(Lj$/util/Optional;)Ljava/util/Optional;
...
.method public final synthetic flatMapToDouble(Ljava/util/function/Function;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->z(Lj$/util/stream/a;)Lj$/util/stream/F;
...
.method public final synthetic max(Ljava/util/Comparator;)Ljava/util/Optional;
    ...
    invoke-static {p1}, Lj$/util/b;->m(Lj$/util/Optional;)Ljava/util/Optional;
