...
.method constructor <init>(Lj$/util/stream/b;Lj$/util/stream/b;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)V
    ...
    iput-object p1, p0, Lj$/util/stream/f4;->j:Lj$/util/stream/b;

    iput-object p4, p0, Lj$/util/stream/f4;->k:Ljava/util/function/IntFunction;
    ...
    iput-boolean p1, p0, Lj$/util/stream/f4;->l:Z
...
.method constructor <init>(Lj$/util/stream/f4;Lj$/util/Spliterator;)V
    ...
    iget-object p2, p1, Lj$/util/stream/f4;->j:Lj$/util/stream/b;

    iput-object p2, p0, Lj$/util/stream/f4;->j:Lj$/util/stream/b;

    iget-object p2, p1, Lj$/util/stream/f4;->k:Ljava/util/function/IntFunction;

    iput-object p2, p0, Lj$/util/stream/f4;->k:Ljava/util/function/IntFunction;

    iget-boolean p1, p1, Lj$/util/stream/f4;->l:Z
...
.method protected final a()Ljava/lang/Object;
    ...
    iget-object v3, p0, Lj$/util/stream/f4;->k:Ljava/util/function/IntFunction;

    invoke-virtual {v0, v1, v2, v3}, Lj$/util/stream/b;->N(JLjava/util/function/IntFunction;)Lj$/util/stream/C0;

    move-result-object v0

    iget-object v1, p0, Lj$/util/stream/f4;->j:Lj$/util/stream/b;
    ...
    invoke-virtual {v1, v2, v0}, Lj$/util/stream/b;->R(ILj$/util/stream/p2;)Lj$/util/stream/p2;

    move-result-object v1

    iget-object v2, p0, Lj$/util/stream/e;->a:Lj$/util/stream/b;

    invoke-virtual {v2, v1}, Lj$/util/stream/b;->W(Lj$/util/stream/p2;)Lj$/util/stream/p2;

    move-result-object v1

    iget-object v3, p0, Lj$/util/stream/e;->b:Lj$/util/Spliterator;

    invoke-virtual {v2, v3, v1}, Lj$/util/stream/b;->B(Lj$/util/Spliterator;Lj$/util/stream/p2;)Z

    move-result v1

    iput-boolean v1, p0, Lj$/util/stream/f4;->n:Z
    ...
    iput-wide v1, p0, Lj$/util/stream/f4;->m:J
...
.method protected final h()V
    ...
    iget-boolean v0, p0, Lj$/util/stream/f4;->l:Z

    if-eqz v0, :cond_0

    iget-boolean v0, p0, Lj$/util/stream/f4;->o:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lj$/util/stream/f4;->j:Lj$/util/stream/b;

    invoke-virtual {v0}, Lj$/util/stream/b;->I()Lj$/util/stream/e3;

    move-result-object v0

    invoke-static {v0}, Lj$/util/stream/y0;->L(Lj$/util/stream/e3;)Lj$/util/stream/e1;
...
.method public final onCompletion(Ljava/util/concurrent/CountedCompleter;)V
    ...
    iget-boolean v0, v0, Lj$/util/stream/f4;->n:Z

    iget-object v1, p0, Lj$/util/stream/e;->e:Lj$/util/stream/e;

    check-cast v1, Lj$/util/stream/f4;

    iget-boolean v1, v1, Lj$/util/stream/f4;->n:Z

    or-int/2addr v0, v1

    iput-boolean v0, p0, Lj$/util/stream/f4;->n:Z
    ...
    iget-boolean v3, v0, Lj$/util/stream/f4;->n:Z

    if-eqz v3, :cond_2

    iget-wide v1, v0, Lj$/util/stream/f4;->m:J
    ...
    iget-wide v3, v0, Lj$/util/stream/f4;->m:J

    iget-object v5, p0, Lj$/util/stream/e;->e:Lj$/util/stream/e;

    check-cast v5, Lj$/util/stream/f4;

    iget-wide v6, v5, Lj$/util/stream/f4;->m:J

    add-long/2addr v3, v6

    iput-wide v3, p0, Lj$/util/stream/f4;->m:J
    ...
    :cond_3
    iget-wide v3, v5, Lj$/util/stream/f4;->m:J
    ...
    iput-boolean v0, p0, Lj$/util/stream/f4;->o:Z
