...
.method constructor <init>(Lj$/util/stream/b;Lj$/util/Spliterator;Z)V
    ...
    iput-object p1, p0, Lj$/util/stream/f3;->b:Lj$/util/stream/b;

    const/4 p1, 0x0

    iput-object p1, p0, Lj$/util/stream/f3;->c:Ljava/util/function/Supplier;

    iput-object p2, p0, Lj$/util/stream/f3;->d:Lj$/util/Spliterator;
...
.method constructor <init>(Lj$/util/stream/b;Ljava/util/function/Supplier;Z)V
    ...
    iput-object p2, p0, Lj$/util/stream/f3;->c:Ljava/util/function/Supplier;

    const/4 p1, 0x0

    iput-object p1, p0, Lj$/util/stream/f3;->d:Lj$/util/Spliterator;
...
.method private b()Z
    ...
    iget-object v0, p0, Lj$/util/stream/f3;->e:Lj$/util/stream/p2;
    ...
    iget-object v0, p0, Lj$/util/stream/f3;->f:Ljava/util/function/BooleanSupplier;
    ...
    iput-boolean v4, p0, Lj$/util/stream/f3;->i:Z
...
.method final a()Z
    ...
    invoke-interface {v0, v1, v2}, Lj$/util/stream/p2;->l(J)V

    invoke-direct {p0}, Lj$/util/stream/f3;->b()Z
...
.method final c()V
    ...
    iget-object v0, p0, Lj$/util/stream/f3;->c:Ljava/util/function/Supplier;
    ...
    iput-object v0, p0, Lj$/util/stream/f3;->c:Ljava/util/function/Supplier;
...
.method public final characteristics()I
    ...
    invoke-static {v0}, Lj$/util/stream/d3;->C(I)I

    move-result v0

    sget v1, Lj$/util/stream/d3;->f:I
...
.method abstract e(Lj$/util/Spliterator;)Lj$/util/stream/f3;
.end method
...
.method public trySplit()Lj$/util/Spliterator;
    ...
    :cond_0
    invoke-virtual {p0, v0}, Lj$/util/stream/f3;->e(Lj$/util/Spliterator;)Lj$/util/stream/f3;
