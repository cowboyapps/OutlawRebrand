...
.field private final e:Lj$/util/stream/S;
...
.method constructor <init>(Lj$/util/stream/T;Lj$/util/Spliterator;Lj$/util/stream/T;)V
    ...
    iget-object v0, p1, Lj$/util/stream/T;->a:Lj$/util/stream/b;

    iput-object v0, p0, Lj$/util/stream/T;->a:Lj$/util/stream/b;
    ...
    iget-object p1, p1, Lj$/util/stream/T;->e:Lj$/util/stream/S;

    iput-object p1, p0, Lj$/util/stream/T;->e:Lj$/util/stream/S;
...
.method protected constructor <init>(Lj$/util/stream/b;Lj$/util/Spliterator;Lj$/util/stream/S;)V
    .locals 3
    ...
    iput-object p1, p0, Lj$/util/stream/T;->a:Lj$/util/stream/b;
    ...
    iput-object p3, p0, Lj$/util/stream/T;->e:Lj$/util/stream/S;
...
.method public final compute()V
    ...
    iget-object v2, v4, Lj$/util/stream/T;->a:Lj$/util/stream/b;
    ...
    invoke-virtual {v2, v0, v1}, Lj$/util/stream/b;->V(Lj$/util/Spliterator;Lj$/util/stream/p2;)Lj$/util/stream/p2;

    invoke-interface {v1}, Lj$/util/stream/C0;->a()Lj$/util/stream/K0;

    move-result-object v0

    iput-object v0, v4, Lj$/util/stream/T;->g:Lj$/util/stream/K0;
...
.method public final onCompletion(Ljava/util/concurrent/CountedCompleter;)V
    ...
    iget-object p1, p0, Lj$/util/stream/T;->g:Lj$/util/stream/K0;

    const/4 v0, 0x0

    if-eqz p1, :cond_0

    iget-object v1, p0, Lj$/util/stream/T;->e:Lj$/util/stream/S;

    invoke-interface {p1, v1}, Lj$/util/stream/K0;->forEach(Ljava/util/function/Consumer;)V

    iput-object v0, p0, Lj$/util/stream/T;->g:Lj$/util/stream/K0;
    ...
    iget-object v1, p0, Lj$/util/stream/T;->a:Lj$/util/stream/b;

    iget-object v2, p0, Lj$/util/stream/T;->e:Lj$/util/stream/S;

    invoke-virtual {v1, p1, v2}, Lj$/util/stream/b;->V(Lj$/util/Spliterator;Lj$/util/stream/p2;)Lj$/util/stream/p2;
