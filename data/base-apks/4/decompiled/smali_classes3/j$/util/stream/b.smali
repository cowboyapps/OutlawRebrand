...
.method constructor <init>(Lj$/util/stream/b;I)V
    ...
    invoke-static {p2, v1}, Lj$/util/stream/d3;->n(II)I
...
.method private S(I)Lj$/util/Spliterator;
    ...
    invoke-static {v4, v0}, Lj$/util/stream/d3;->n(II)I
    ...
    invoke-static {p1, v0}, Lj$/util/stream/d3;->n(II)I
...
# virtual methods
.method final A(Lj$/util/Spliterator;Lj$/util/stream/p2;)V
    .locals 2
    ...
    :cond_0
    invoke-virtual {p0, p1, p2}, Lj$/util/stream/b;->B(Lj$/util/Spliterator;Lj$/util/stream/p2;)Z

    :goto_0
    return-void
.end method

.method final B(Lj$/util/Spliterator;Lj$/util/stream/p2;)Z
    .locals 3
    ...
    invoke-virtual {v0, p1, p2}, Lj$/util/stream/b;->H(Lj$/util/Spliterator;Lj$/util/stream/p2;)Z
...
.method final C(Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/K0;
    ...
    invoke-virtual {p0, p1, p2}, Lj$/util/stream/b;->V(Lj$/util/Spliterator;Lj$/util/stream/p2;)Lj$/util/stream/p2;
...
.method final D(Lj$/util/stream/J3;)Ljava/lang/Object;
    .locals 1
    ...
    invoke-interface {p1}, Lj$/util/stream/J3;->d()I
    ...
    invoke-interface {p1, p0, v0}, Lj$/util/stream/J3;->c(Lj$/util/stream/b;Lj$/util/Spliterator;)Ljava/lang/Object;
    ...
    invoke-interface {p1, p0, v0}, Lj$/util/stream/J3;->b(Lj$/util/stream/b;Lj$/util/Spliterator;)Ljava/lang/Object;
...
.method abstract H(Lj$/util/Spliterator;Lj$/util/stream/p2;)Z
.end method

.method abstract I()Lj$/util/stream/e3;
.end method

.method final J()Lj$/util/stream/e3;
    .locals 2
...
.method abstract R(ILj$/util/stream/p2;)Lj$/util/stream/p2;
.end method
...
.method final V(Lj$/util/Spliterator;Lj$/util/stream/p2;)Lj$/util/stream/p2;
    .locals 1
    ...
    invoke-virtual {p0, v0}, Lj$/util/stream/b;->W(Lj$/util/stream/p2;)Lj$/util/stream/p2;

    move-result-object v0

    invoke-virtual {p0, p1, v0}, Lj$/util/stream/b;->A(Lj$/util/Spliterator;Lj$/util/stream/p2;)V

    return-object p2
.end method

.method final W(Lj$/util/stream/p2;)Lj$/util/stream/p2;
    .locals 3
    ...
    invoke-virtual {v0, v2, p1}, Lj$/util/stream/b;->R(ILj$/util/stream/p2;)Lj$/util/stream/p2;
...
.method public final onClose(Ljava/lang/Runnable;)Lj$/util/stream/h;
    ...
    invoke-direct {v2, v1, p1}, Lj$/util/stream/I3;-><init>(Ljava/lang/Runnable;Ljava/lang/Runnable;)V
