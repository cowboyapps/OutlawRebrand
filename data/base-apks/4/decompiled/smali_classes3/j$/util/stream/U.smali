...
.field private final b:Lj$/util/stream/p2;
...
.method constructor <init>(Lj$/util/stream/U;Lj$/util/Spliterator;)V
    ...
    iget-object p2, p1, Lj$/util/stream/U;->b:Lj$/util/stream/p2;

    iput-object p2, p0, Lj$/util/stream/U;->b:Lj$/util/stream/p2;

    iget-wide v0, p1, Lj$/util/stream/U;->d:J

    iput-wide v0, p0, Lj$/util/stream/U;->d:J

    iget-object p1, p1, Lj$/util/stream/U;->c:Lj$/util/stream/b;
...
.method constructor <init>(Lj$/util/stream/b;Lj$/util/Spliterator;Lj$/util/stream/p2;)V
    .locals 1
    ...
    iput-object p3, p0, Lj$/util/stream/U;->b:Lj$/util/stream/p2;
...
.method public final compute()V
    ...
    :cond_0
    sget-object v5, Lj$/util/stream/d3;->SHORT_CIRCUIT:Lj$/util/stream/d3;

    iget-object v6, p0, Lj$/util/stream/U;->c:Lj$/util/stream/b;
    ...
    iget-object v6, p0, Lj$/util/stream/U;->b:Lj$/util/stream/p2;
    ...
    invoke-interface {v6}, Lj$/util/stream/p2;->n()Z
    ...
    :cond_4
    :goto_2
    iget-object v1, v8, Lj$/util/stream/U;->c:Lj$/util/stream/b;

    invoke-virtual {v1, v0, v6}, Lj$/util/stream/b;->A(Lj$/util/Spliterator;Lj$/util/stream/p2;)V
