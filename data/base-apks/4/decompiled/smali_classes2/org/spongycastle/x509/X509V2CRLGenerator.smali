...
.method public addCRL(Ljava/security/cert/X509CRL;)V
    ...
    invoke-virtual {v4, v5}, Lorg/spongycastle/asn1/x509/V2TBSCertListGenerator;->addCRLEntry(Lorg/spongycastle/asn1/ASN1Sequence;)V
    :try_end_0
...
.method public generate(Ljava/security/PrivateKey;Ljava/lang/String;Ljava/security/SecureRandom;)Ljava/security/cert/X509CRL;
    ...
    invoke-direct {p0, v6, v0}, Lorg/spongycastle/x509/X509V2CRLGenerator;->generateJcaObject(Lorg/spongycastle/asn1/x509/TBSCertList;[B)Ljava/security/cert/X509CRL;
    ...
    new-instance v1, Lorg/spongycastle/x509/X509V2CRLGenerator$ExtCRLException;

    const-string v2, "cannot generate CRL encoding"

    invoke-direct {v1, v2, v0}, Lorg/spongycastle/x509/X509V2CRLGenerator$ExtCRLException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public generate(Ljava/security/PrivateKey;Ljava/security/SecureRandom;)Ljava/security/cert/X509CRL;
    ...
    invoke-direct {p0, v0, v1}, Lorg/spongycastle/x509/X509V2CRLGenerator;->generateJcaObject(Lorg/spongycastle/asn1/x509/TBSCertList;[B)Ljava/security/cert/X509CRL;
    ...
    new-instance v2, Lorg/spongycastle/x509/X509V2CRLGenerator$ExtCRLException;

    const-string v3, "cannot generate CRL encoding"

    invoke-direct {v2, v3, v1}, Lorg/spongycastle/x509/X509V2CRLGenerator$ExtCRLException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public setSignatureAlgorithm(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lorg/spongycastle/x509/X509V2CRLGenerator;->sigAlgId:Lorg/spongycastle/asn1/x509/AlgorithmIdentifier;
