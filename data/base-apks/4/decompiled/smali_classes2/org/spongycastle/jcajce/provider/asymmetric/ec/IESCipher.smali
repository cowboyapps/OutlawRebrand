...
.method public engineDoFinal([BII)[B
    ...
    invoke-direct {v1, v2, v3, v4, v5}, Lorg/spongycastle/crypto/params/IESWithCipherParameters;-><init>([B[BII)V
    ...
    invoke-virtual {v3, v7, v4, v6, v1}, Lorg/spongycastle/crypto/engines/IESEngine;->init(ZLorg/spongycastle/crypto/CipherParameters;Lorg/spongycastle/crypto/CipherParameters;Lorg/spongycastle/crypto/CipherParameters;)V
    ...
    invoke-virtual {v3, v6, v4, v8, v1}, Lorg/spongycastle/crypto/engines/IESEngine;->init(ZLorg/spongycastle/crypto/CipherParameters;Lorg/spongycastle/crypto/CipherParameters;Lorg/spongycastle/crypto/CipherParameters;)V
    ...
    invoke-virtual {v3, v0, v7, v4}, Lorg/spongycastle/crypto/engines/IESEngine;->processBlock([BII)[B
    ...
    new-instance v4, Lorg/spongycastle/jcajce/provider/util/BadBlockException;

    invoke-direct {v4, v5, v3}, Lorg/spongycastle/jcajce/provider/util/BadBlockException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    new-instance v6, Lorg/spongycastle/crypto/parsers/ECIESPublicKeyParser;

    invoke-direct {v6, v2}, Lorg/spongycastle/crypto/parsers/ECIESPublicKeyParser;-><init>(Lorg/spongycastle/crypto/params/ECDomainParameters;)V

    invoke-virtual {v3, v4, v1, v6}, Lorg/spongycastle/crypto/engines/IESEngine;->init(Lorg/spongycastle/crypto/params/AsymmetricKeyParameter;Lorg/spongycastle/crypto/CipherParameters;Lorg/spongycastle/crypto/KeyParser;)V
    ...
    iget-object v6, p0, Lorg/spongycastle/jcajce/provider/asymmetric/ec/IESCipher;->random:Ljava/security/SecureRandom;

    invoke-direct {v4, v2, v6}, Lorg/spongycastle/crypto/params/ECKeyGenerationParameters;-><init>(Lorg/spongycastle/crypto/params/ECDomainParameters;Ljava/security/SecureRandom;)V
    ...
    invoke-virtual {v4}, Lorg/spongycastle/jce/spec/IESParameterSpec;->getPointCompression()Z

    move-result v4

    new-instance v6, Lorg/spongycastle/crypto/generators/EphemeralKeyPairGenerator;

    new-instance v8, Lorg/spongycastle/jcajce/provider/asymmetric/ec/IESCipher$1;

    invoke-direct {v8, p0, v4}, Lorg/spongycastle/jcajce/provider/asymmetric/ec/IESCipher$1;-><init>(Lorg/spongycastle/jcajce/provider/asymmetric/ec/IESCipher;Z)V

    invoke-direct {v6, v3, v8}, Lorg/spongycastle/crypto/generators/EphemeralKeyPairGenerator;-><init>(Lorg/spongycastle/crypto/AsymmetricCipherKeyPairGenerator;Lorg/spongycastle/crypto/KeyEncoder;)V
    ...
    invoke-virtual {v8, v9, v1, v6}, Lorg/spongycastle/crypto/engines/IESEngine;->init(Lorg/spongycastle/crypto/params/AsymmetricKeyParameter;Lorg/spongycastle/crypto/CipherParameters;Lorg/spongycastle/crypto/generators/EphemeralKeyPairGenerator;)V

    iget-object v8, p0, Lorg/spongycastle/jcajce/provider/asymmetric/ec/IESCipher;->engine:Lorg/spongycastle/crypto/engines/IESEngine;

    array-length v9, v0

    invoke-virtual {v8, v0, v7, v9}, Lorg/spongycastle/crypto/engines/IESEngine;->processBlock([BII)[B
    ...
    invoke-direct {v8, v5, v7}, Lorg/spongycastle/jcajce/provider/util/BadBlockException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public engineGetKeySize(Ljava/security/Key;)I
    ...
    invoke-interface {v0}, Lorg/spongycastle/jce/interfaces/ECKey;->getParameters()Lorg/spongycastle/jce/spec/ECParameterSpec;
...
.method public engineGetOutputSize(I)I
    ...
    invoke-virtual {v2, v8}, Lorg/spongycastle/crypto/BufferedBlockCipher;->getOutputSize(I)I
...
.method public engineInit(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    check-cast v1, Lorg/spongycastle/jce/spec/IESParameterSpec;
    ...
    const-string v3, "NONCE in IES Parameters needs to be "
    ...
    invoke-static {v0}, Lorg/spongycastle/jcajce/provider/asymmetric/ec/ECUtils;->generatePublicKeyParameter(Ljava/security/PublicKey;)Lorg/spongycastle/crypto/params/AsymmetricKeyParameter;
