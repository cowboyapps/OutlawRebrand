...
.method private decodeKey(Ljava/io/DataInputStream;)Ljava/security/Key;
    ...
    invoke-interface {v5, v2}, Lorg/spongycastle/jcajce/util/JcaJceHelper;->createSecretKeyFactory(Ljava/lang/String;)Ljavax/crypto/SecretKeyFactory;
    ...
    invoke-interface {v5, v2}, Lorg/spongycastle/jcajce/util/JcaJceHelper;->createKeyFactory(Ljava/lang/String;)Ljava/security/KeyFactory;
...
.method public engineLoad(Ljava/io/InputStream;[C)V
    ...
    iget-object v3, v0, Lorg/spongycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->table:Ljava/util/Hashtable;
    ...
    new-instance v9, Lorg/spongycastle/crypto/macs/HMac;
    ...
    invoke-direct {v9, v10}, Lorg/spongycastle/crypto/macs/HMac;-><init>(Lorg/spongycastle/crypto/Digest;)V
    ...
    new-instance v11, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;
    ...
    invoke-direct {v11, v12}, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;-><init>(Lorg/spongycastle/crypto/Digest;)V

    invoke-virtual {v11, v10, v7, v8}, Lorg/spongycastle/crypto/PBEParametersGenerator;->init([B[BI)V

    if-eq v4, v5, :cond_3

    invoke-virtual {v9}, Lorg/spongycastle/crypto/macs/HMac;->getMacSize()I

    move-result v5

    invoke-virtual {v11, v5}, Lorg/spongycastle/crypto/PBEParametersGenerator;->generateDerivedMacParameters(I)Lorg/spongycastle/crypto/CipherParameters;
    ...
    invoke-static {v10, v12}, Lorg/spongycastle/util/Arrays;->fill([BB)V

    invoke-virtual {v9, v5}, Lorg/spongycastle/crypto/macs/HMac;->init(Lorg/spongycastle/crypto/CipherParameters;)V

    new-instance v13, Lorg/spongycastle/crypto/io/MacInputStream;

    invoke-direct {v13, v3, v9}, Lorg/spongycastle/crypto/io/MacInputStream;-><init>(Ljava/io/InputStream;Lorg/spongycastle/crypto/Mac;)V

    invoke-virtual {v0, v13}, Lorg/spongycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->loadStore(Ljava/io/InputStream;)V
    ...
    invoke-virtual {v9, v14, v12}, Lorg/spongycastle/crypto/macs/HMac;->doFinal([BI)I
    ...
    invoke-static {v14, v12}, Lorg/spongycastle/util/Arrays;->constantTimeAreEqual([B[B)Z
    ...
    :cond_4
    iget-object v15, v0, Lorg/spongycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->table:Ljava/util/Hashtable;
    ...
    :cond_5
    invoke-virtual {v0, v3}, Lorg/spongycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->loadStore(Ljava/io/InputStream;)V
...
.method public engineStore(Ljava/io/OutputStream;[C)V
    ...
    invoke-direct {v4, v3}, Lorg/spongycastle/crypto/io/MacOutputStream;-><init>(Lorg/spongycastle/crypto/Mac;)V
    ...
    invoke-virtual {v5, v6, v1, v2}, Lorg/spongycastle/crypto/PBEParametersGenerator;->init([B[BI)V

    iget v7, p0, Lorg/spongycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->version:I

    const/4 v8, 0x2

    if-ge v7, v8, :cond_0

    invoke-virtual {v3}, Lorg/spongycastle/crypto/macs/HMac;->getMacSize()I

    move-result v7

    invoke-virtual {v5, v7}, Lorg/spongycastle/crypto/PBEParametersGenerator;->generateDerivedMacParameters(I)Lorg/spongycastle/crypto/CipherParameters;

    move-result-object v7

    invoke-virtual {v3, v7}, Lorg/spongycastle/crypto/macs/HMac;->init(Lorg/spongycastle/crypto/CipherParameters;)V
    ...
    invoke-direct {v7, v0, v4}, Lorg/spongycastle/util/io/TeeOutputStream;-><init>(Ljava/io/OutputStream;Ljava/io/OutputStream;)V

    invoke-virtual {p0, v7}, Lorg/spongycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->saveStore(Ljava/io/OutputStream;)V
    ...
    invoke-virtual {v3, v7, v9}, Lorg/spongycastle/crypto/macs/HMac;->doFinal([BI)I
...
.method protected loadStore(Ljava/io/InputStream;)V
    ...
    invoke-direct {v11, v13}, Lorg/spongycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->decodeCertificate(Ljava/io/DataInputStream;)Ljava/security/cert/Certificate;
    ...
    iget-object v8, v11, Lorg/spongycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->table:Ljava/util/Hashtable;

    new-instance v9, Lorg/spongycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$StoreEntry;
    ...
    :pswitch_1
    invoke-direct {v11, v13}, Lorg/spongycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->decodeKey(Ljava/io/DataInputStream;)Ljava/security/Key;

    move-result-object v0

    iget-object v1, v11, Lorg/spongycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->table:Ljava/util/Hashtable;
    ...
    invoke-direct/range {v4 .. v10}, Lorg/spongycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$StoreEntry;-><init>(Lorg/spongycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;Ljava/lang/String;Ljava/util/Date;ILjava/lang/Object;[Ljava/security/cert/Certificate;)V
    ...
    invoke-direct/range {v4 .. v9}, Lorg/spongycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$StoreEntry;-><init>(Lorg/spongycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;Ljava/lang/String;Ljava/util/Date;ILjava/lang/Object;)V
...
.method protected saveStore(Ljava/io/OutputStream;)V
    ...
    invoke-virtual {v2}, Lorg/spongycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$StoreEntry;->getDate()Ljava/util/Date;
    ...
    invoke-direct {p0, v5, v1}, Lorg/spongycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->encodeCertificate(Ljava/security/cert/Certificate;Ljava/io/DataOutputStream;)V
    ...
    invoke-direct {p0, v3, v1}, Lorg/spongycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->encodeKey(Ljava/security/Key;Ljava/io/DataOutputStream;)V
    ...
    invoke-direct {p0, v3, v1}, Lorg/spongycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->encodeCertificate(Ljava/security/cert/Certificate;Ljava/io/DataOutputStream;)V
