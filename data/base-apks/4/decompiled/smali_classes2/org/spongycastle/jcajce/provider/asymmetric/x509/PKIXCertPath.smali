...
.method constructor <init>(Ljava/io/InputStream;Ljava/lang/String;)V
    ...
    iput-object v4, p0, Lorg/spongycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->certificates:Ljava/util/List;

    iget-object v4, p0, Lorg/spongycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->helper:Lorg/spongycastle/jcajce/util/JcaJceHelper;

    invoke-interface {v4, v0}, Lorg/spongycastle/jcajce/util/JcaJceHelper;->createCertificateFactory(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
    ...
    iget-object v6, p0, Lorg/spongycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->certificates:Ljava/util/List;
...
.method public getEncoded()[B
    ...
    invoke-virtual {p0, v2}, Lorg/spongycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->getEncoded(Ljava/lang/String;)[B
...
.method public getEncoded(Ljava/lang/String;)[B
    ...
    invoke-direct {p0, v2}, Lorg/spongycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->toASN1Object(Ljava/security/cert/X509Certificate;)Lorg/spongycastle/asn1/ASN1Primitive;
    ...
    invoke-direct {p0, v2}, Lorg/spongycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->toDEREncoded(Lorg/spongycastle/asn1/ASN1Encodable;)[B
    ...
    invoke-direct {v4, v0, v1}, Lorg/spongycastle/asn1/pkcs/ContentInfo;-><init>(Lorg/spongycastle/asn1/ASN1ObjectIdentifier;Lorg/spongycastle/asn1/ASN1Encodable;)V
    ...
    :cond_2
    new-instance v8, Lorg/spongycastle/asn1/pkcs/SignedData;

    new-instance v2, Lorg/spongycastle/asn1/ASN1Integer;

    const-wide/16 v5, 0x1

    invoke-direct {v2, v5, v6}, Lorg/spongycastle/asn1/ASN1Integer;-><init>(J)V
    ...
    invoke-direct/range {v1 .. v7}, Lorg/spongycastle/asn1/pkcs/SignedData;-><init>(Lorg/spongycastle/asn1/ASN1Integer;Lorg/spongycastle/asn1/ASN1Set;Lorg/spongycastle/asn1/pkcs/ContentInfo;Lorg/spongycastle/asn1/ASN1Set;Lorg/spongycastle/asn1/ASN1Set;Lorg/spongycastle/asn1/ASN1Set;)V
    ...
    invoke-direct {v2, v3, v1}, Lorg/spongycastle/asn1/pkcs/ContentInfo;-><init>(Lorg/spongycastle/asn1/ASN1ObjectIdentifier;Lorg/spongycastle/asn1/ASN1Encodable;)V
    ...
    new-instance v1, Lorg/spongycastle/util/io/pem/PemWriter;

    new-instance v2, Ljava/io/OutputStreamWriter;

    invoke-direct {v2, v0}, Ljava/io/OutputStreamWriter;-><init>(Ljava/io/OutputStream;)V

    invoke-direct {v1, v2}, Lorg/spongycastle/util/io/pem/PemWriter;-><init>(Ljava/io/Writer;)V
    ...
    iget-object v5, p0, Lorg/spongycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->certificates:Ljava/util/List;
    ...
    invoke-direct {v3, v4, v5}, Lorg/spongycastle/util/io/pem/PemObject;-><init>(Ljava/lang/String;[B)V

    invoke-virtual {v1, v3}, Lorg/spongycastle/util/io/pem/PemWriter;->writeObject(Lorg/spongycastle/util/io/pem/PemObjectGenerator;)V
    ...
    :cond_4
    invoke-virtual {v1}, Lorg/spongycastle/util/io/pem/PemWriter;->close()V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
