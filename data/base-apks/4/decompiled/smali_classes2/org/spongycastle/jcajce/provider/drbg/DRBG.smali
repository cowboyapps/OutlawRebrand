...
.method private static createBaseRandom(Z)Ljava/security/SecureRandom;
    ...
    invoke-static {v5, v6}, Lorg/spongycastle/util/Arrays;->concatenate([B[B)[B

    move-result-object v5

    invoke-virtual {v3, v4, v5, p0}, Lorg/spongycastle/crypto/prng/SP800SecureRandomBuilder;->buildHash(Lorg/spongycastle/crypto/Digest;[BZ)Lorg/spongycastle/crypto/prng/SP800SecureRandom;
    ...
    invoke-virtual {v2, v3, v4, p0}, Lorg/spongycastle/crypto/prng/SP800SecureRandomBuilder;->buildHash(Lorg/spongycastle/crypto/Digest;[BZ)Lorg/spongycastle/crypto/prng/SP800SecureRandom;
...
.method private static final findSource()[Ljava/lang/Object;
    ...
    :goto_0
    sget-object v1, Lorg/spongycastle/jcajce/provider/drbg/DRBG;->initialEntropySourceNames:[[Ljava/lang/String;
