...
.method public static generateKeyFingerprint(Lorg/spongycastle/math/ec/ECPoint;Lorg/spongycastle/jce/spec/ECParameterSpec;)Ljava/lang/String;
    ...
    new-instance v3, Lorg/spongycastle/util/Fingerprint;

    invoke-virtual {p0, v2}, Lorg/spongycastle/math/ec/ECPoint;->getEncoded(Z)[B
    ...
    invoke-virtual {v6}, Lorg/spongycastle/math/ec/ECFieldElement;->getEncoded()[B
    ...
    invoke-static {v4, v5, v6, v2}, Lorg/spongycastle/util/Arrays;->concatenate([B[B[B[B)[B

    move-result-object v2

    invoke-direct {v3, v2}, Lorg/spongycastle/util/Fingerprint;-><init>([B)V

    invoke-virtual {v3}, Lorg/spongycastle/util/Fingerprint;->toString()Ljava/lang/String;
...
.method public static generatePrivateKeyParameter(Ljava/security/PrivateKey;)Lorg/spongycastle/crypto/params/AsymmetricKeyParameter;
    ...
    invoke-interface {v0}, Lorg/spongycastle/jce/interfaces/ECPrivateKey;->getParameters()Lorg/spongycastle/jce/spec/ECParameterSpec;
    ...
    invoke-direct {v2, v3, v10}, Lorg/spongycastle/crypto/params/ECPrivateKeyParameters;-><init>(Ljava/math/BigInteger;Lorg/spongycastle/crypto/params/ECDomainParameters;)V
...
.method public static generatePublicKeyParameter(Ljava/security/PublicKey;)Lorg/spongycastle/crypto/params/AsymmetricKeyParameter;
    ...
    invoke-interface {v0}, Lorg/spongycastle/jce/interfaces/ECPublicKey;->getParameters()Lorg/spongycastle/jce/spec/ECParameterSpec;

    move-result-object v1

    new-instance v2, Lorg/spongycastle/crypto/params/ECPublicKeyParameters;

    invoke-interface {v0}, Lorg/spongycastle/jce/interfaces/ECPublicKey;->getQ()Lorg/spongycastle/math/ec/ECPoint;
    ...
    invoke-direct {v2, v3, v10}, Lorg/spongycastle/crypto/params/ECPublicKeyParameters;-><init>(Lorg/spongycastle/math/ec/ECPoint;Lorg/spongycastle/crypto/params/ECDomainParameters;)V
    ...
    invoke-static {v4, v5, v2}, Lorg/spongycastle/jcajce/provider/asymmetric/util/EC5Util;->convertPoint(Ljava/security/spec/ECParameterSpec;Ljava/security/spec/ECPoint;Z)Lorg/spongycastle/math/ec/ECPoint;
    ...
    invoke-direct {v3, v2, v10}, Lorg/spongycastle/crypto/params/ECPublicKeyParameters;-><init>(Lorg/spongycastle/math/ec/ECPoint;Lorg/spongycastle/crypto/params/ECDomainParameters;)V
...
.method public static getNamedCurveOid(Ljava/lang/String;)Lorg/spongycastle/asn1/ASN1ObjectIdentifier;
    ...
    :cond_1
    invoke-static {v0}, Lorg/spongycastle/jcajce/provider/asymmetric/util/ECUtil;->lookupOidByName(Ljava/lang/String;)Lorg/spongycastle/asn1/ASN1ObjectIdentifier;
