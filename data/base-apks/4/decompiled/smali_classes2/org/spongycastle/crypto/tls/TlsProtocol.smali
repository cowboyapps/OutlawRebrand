...
.method protected static establishMasterSecret(Lorg/spongycastle/crypto/tls/TlsContext;Lorg/spongycastle/crypto/tls/TlsKeyExchange;)V
    ...
    iput-object v3, v2, Lorg/spongycastle/crypto/tls/SecurityParameters;->masterSecret:[B
    :try_end_0
...
.method private processAlertQueue()V
    ...
    invoke-virtual {p0, v1, v2}, Lorg/spongycastle/crypto/tls/TlsProtocol;->handleAlertMessage(SS)V
...
.method private processChangeCipherSpec([BII)V
    ...
    iget-boolean v3, p0, Lorg/spongycastle/crypto/tls/TlsProtocol;->receivedChangeCipherSpec:Z
    ...
    invoke-virtual {v3}, Lorg/spongycastle/crypto/tls/RecordStream;->receivedReadCipherSpec()V
...
.method private processHandshakeQueue(Lorg/spongycastle/crypto/tls/ByteQueue;)V
    ...
    invoke-virtual {p1, v2, v6}, Lorg/spongycastle/crypto/tls/ByteQueue;->copyTo(Ljava/io/OutputStream;I)V

    :goto_2
    invoke-virtual {p1, v1}, Lorg/spongycastle/crypto/tls/ByteQueue;->removeData(I)V

    invoke-virtual {p1, v5}, Lorg/spongycastle/crypto/tls/ByteQueue;->readFrom(I)Ljava/io/ByteArrayInputStream;

    move-result-object v1

    invoke-virtual {p0, v3, v1}, Lorg/spongycastle/crypto/tls/TlsProtocol;->handleHandshakeMessage(SLjava/io/ByteArrayInputStream;)V
...
.method protected static readSupplementalDataMessage(Ljava/io/ByteArrayInputStream;)Ljava/util/Vector;
    ...
    invoke-direct {v5, v3, v4}, Lorg/spongycastle/crypto/tls/SupplementalDataEntry;-><init>(I[B)V
...
.method protected static writeSelectedExtensions(Ljava/io/OutputStream;Ljava/util/Hashtable;Z)V
    ...
    invoke-static {v3, p0}, Lorg/spongycastle/crypto/tls/TlsUtils;->writeOpaque16([BLjava/io/OutputStream;)V
...
.method protected static writeSupplementalData(Ljava/io/OutputStream;Ljava/util/Vector;)V
    ...
    invoke-static {v1, p0}, Lorg/spongycastle/crypto/tls/TlsUtils;->writeOpaque24([BLjava/io/OutputStream;)V
...
.method protected processRecord(S[BII)V
    ...
    invoke-direct {v0, p2, p3, p4}, Lorg/spongycastle/crypto/tls/ByteQueue;-><init>([BII)V
    ...
    invoke-virtual {v2, p2, v3, v1}, Lorg/spongycastle/crypto/tls/ByteQueue;->addData([BII)V
...
.method protected raiseAlertFatal(SLjava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v3, v4, v0, v2, v1}, Lorg/spongycastle/crypto/tls/RecordStream;->writeRecord(S[BII)V
    :try_end_0
...
.method protected raiseAlertWarning(SLjava/lang/String;)V
    ...
    invoke-virtual {p0, v2, v1, v3, v0}, Lorg/spongycastle/crypto/tls/TlsProtocol;->safeWriteRecord(S[BII)V
...
.method protected readApplicationData([BII)I
    ...
    const-string v1, "Cannot read application data until initial handshake completed."
    ...
    const-string v1, "Cannot read application data on failed TLS connection"
...
.method protected sendCertificateMessage(Lorg/spongycastle/crypto/tls/Certificate;)V
    ...
    const-string v3, " client didn\'t provide credentials"
    ...
    invoke-virtual {p0, v3, v2}, Lorg/spongycastle/crypto/tls/TlsProtocol;->raiseAlertWarning(SLjava/lang/String;)V
...
.method protected sendChangeCipherSpecMessage()V
    ...
    invoke-virtual {p0, v1, v0, v2, v3}, Lorg/spongycastle/crypto/tls/TlsProtocol;->safeWriteRecord(S[BII)V
...
.method protected writeData([BII)V
    ...
    const-string v1, "Cannot write application data on closed/failed TLS connection"
...
.method protected writeHandshakeMessage([BII)V
    ...
    invoke-virtual {v1}, Lorg/spongycastle/crypto/tls/RecordStream;->getHandshakeHashUpdater()Ljava/io/OutputStream;
    ...
    invoke-virtual {v3}, Lorg/spongycastle/crypto/tls/RecordStream;->getPlaintextLimit()I
    ...
    invoke-virtual {p0, v3, p1, v4, v2}, Lorg/spongycastle/crypto/tls/TlsProtocol;->safeWriteRecord(S[BII)V
