...
.method private generateDerivedKey(II)[B
    ...
    iget-object v4, v0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->salt:[B
    ...
    iget v4, v0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->v:I

    iget-object v7, v0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->salt:[B
    ...
    iget-object v9, v0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->salt:[B
    ...
    :goto_2
    iget-object v7, v0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->password:[B
    ...
    iget v7, v0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->v:I

    iget-object v8, v0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->password:[B
    ...
    iget-object v10, v0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->password:[B
    ...
    iget v10, v0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->u:I
    ...
    iget-object v13, v0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->digest:Lorg/spongycastle/crypto/Digest;

    array-length v14, v2

    invoke-interface {v13, v2, v6, v14}, Lorg/spongycastle/crypto/Digest;->update([BII)V

    iget-object v13, v0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->digest:Lorg/spongycastle/crypto/Digest;

    array-length v14, v8

    invoke-interface {v13, v8, v6, v14}, Lorg/spongycastle/crypto/Digest;->update([BII)V

    iget-object v13, v0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->digest:Lorg/spongycastle/crypto/Digest;

    invoke-interface {v13, v11, v6}, Lorg/spongycastle/crypto/Digest;->doFinal([BI)I

    const/4 v13, 0x1

    :goto_6
    iget v14, v0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->iterationCount:I

    if-ge v13, v14, :cond_5

    iget-object v14, v0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->digest:Lorg/spongycastle/crypto/Digest;

    array-length v15, v11

    invoke-interface {v14, v11, v6, v15}, Lorg/spongycastle/crypto/Digest;->update([BII)V

    iget-object v14, v0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->digest:Lorg/spongycastle/crypto/Digest;

    invoke-interface {v14, v11, v6}, Lorg/spongycastle/crypto/Digest;->doFinal([BI)I
    ...
    iget v14, v0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->v:I

    mul-int/2addr v14, v13

    invoke-direct {v0, v8, v14, v9}, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->adjust([BI[B)V
    ...
    iget v14, v0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->u:I
    ...
    iget v6, v0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->u:I
