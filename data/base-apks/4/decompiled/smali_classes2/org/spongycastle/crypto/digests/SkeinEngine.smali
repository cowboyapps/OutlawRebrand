...
.method private createInitialState()V
    ...
    invoke-direct {v1, v2, v3}, Lorg/spongycastle/crypto/digests/SkeinEngine$Configuration;-><init>(J)V
    ...
    :goto_1
    iget-object v2, p0, Lorg/spongycastle/crypto/digests/SkeinEngine;->preMessageParameters:[Lorg/spongycastle/crypto/digests/SkeinEngine$Parameter;
    ...
    iput-object v1, p0, Lorg/spongycastle/crypto/digests/SkeinEngine;->initialState:[J
...
.method private initParams(Ljava/util/Hashtable;)V
    ...
    new-array v3, v3, [Lorg/spongycastle/crypto/digests/SkeinEngine$Parameter;

    iput-object v3, p0, Lorg/spongycastle/crypto/digests/SkeinEngine;->preMessageParameters:[Lorg/spongycastle/crypto/digests/SkeinEngine$Parameter;
    ...
    invoke-static {v3}, Lorg/spongycastle/crypto/digests/SkeinEngine;->sort([Lorg/spongycastle/crypto/digests/SkeinEngine$Parameter;)V
    ...
    iput-object v3, p0, Lorg/spongycastle/crypto/digests/SkeinEngine;->postMessageParameters:[Lorg/spongycastle/crypto/digests/SkeinEngine$Parameter;

    iget-object v3, p0, Lorg/spongycastle/crypto/digests/SkeinEngine;->postMessageParameters:[Lorg/spongycastle/crypto/digests/SkeinEngine$Parameter;
...
.method private output(J[BII)V
    ...
    invoke-direct {p0, v4}, Lorg/spongycastle/crypto/digests/SkeinEngine;->ubiInit(I)V

    iget-object v4, p0, Lorg/spongycastle/crypto/digests/SkeinEngine;->ubi:Lorg/spongycastle/crypto/digests/SkeinEngine$UBI;

    array-length v5, v1

    invoke-virtual {v4, v1, v2, v5, v3}, Lorg/spongycastle/crypto/digests/SkeinEngine$UBI;->update([BII[J)V

    iget-object v4, p0, Lorg/spongycastle/crypto/digests/SkeinEngine;->ubi:Lorg/spongycastle/crypto/digests/SkeinEngine$UBI;

    invoke-virtual {v4, v3}, Lorg/spongycastle/crypto/digests/SkeinEngine$UBI;->doFinal([J)V
    ...
    invoke-static {v7, v8, p3, v9}, Lorg/spongycastle/crypto/engines/ThreefishEngine;->wordToBytes(J[BI)V
    ...
    invoke-static {v7, v8, v1, v2}, Lorg/spongycastle/crypto/engines/ThreefishEngine;->wordToBytes(J[BI)V

    mul-int/lit8 v7, v5, 0x8

    add-int/2addr v7, p4

    invoke-static {v1, v2, p3, v7, v6}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
...
.method private ubiComplete(I[B)V
    ...
    invoke-virtual {v0, p2, v3, v1, v2}, Lorg/spongycastle/crypto/digests/SkeinEngine$UBI;->update([BII[J)V
...
.method public doFinal([BI)I
    ...
    invoke-direct {p0, v2, v3}, Lorg/spongycastle/crypto/digests/SkeinEngine;->ubiComplete(I[B)V
    ...
    invoke-direct/range {v4 .. v9}, Lorg/spongycastle/crypto/digests/SkeinEngine;->output(J[BII)V
