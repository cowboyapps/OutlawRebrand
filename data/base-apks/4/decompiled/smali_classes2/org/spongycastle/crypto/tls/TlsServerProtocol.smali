...
.method public constructor <init>(Ljava/io/InputStream;Ljava/io/OutputStream;Ljava/security/SecureRandom;)V
    ...
    iput-object v0, p0, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->tlsServer:Lorg/spongycastle/crypto/tls/TlsServer;
    ...
    iput-short v1, p0, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->clientCertificateType:S
...
.method public accept(Lorg/spongycastle/crypto/tls/TlsServer;)V
    ...
    iget-object v3, p0, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->tlsServerContext:Lorg/spongycastle/crypto/tls/TlsServerContextImpl;
    ...
    invoke-static {v2, v3}, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->createRandomBlock(ZLorg/spongycastle/crypto/prng/RandomGenerator;)[B
    ...
    invoke-interface {v0, v2}, Lorg/spongycastle/crypto/tls/TlsServer;->init(Lorg/spongycastle/crypto/tls/TlsServerContext;)V
    ...
    invoke-virtual {v0, v1}, Lorg/spongycastle/crypto/tls/RecordStream;->setRestrictReadVersion(Z)V
...
.method protected handleHandshakeMessage(SLjava/io/ByteArrayInputStream;)V
    ...
    :sswitch_2
    iget-short v2, p0, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->connection_state:S
    ...
    invoke-interface {v2, v0}, Lorg/spongycastle/crypto/tls/TlsServer;->processClientSupplementalData(Ljava/util/Vector;)V
    ...
    invoke-interface {v1}, Lorg/spongycastle/crypto/tls/TlsServer;->getServerSupplementalData()Ljava/util/Vector;

    move-result-object v1

    if-eqz v1, :cond_8

    invoke-virtual {p0, v1}, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->sendSupplementalDataMessage(Ljava/util/Vector;)V
    ...
    iput-object v2, p0, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->keyExchange:Lorg/spongycastle/crypto/tls/TlsKeyExchange;

    iget-object v2, p0, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->keyExchange:Lorg/spongycastle/crypto/tls/TlsKeyExchange;

    invoke-virtual {p0}, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->getContext()Lorg/spongycastle/crypto/tls/TlsContext;

    move-result-object v3

    invoke-interface {v2, v3}, Lorg/spongycastle/crypto/tls/TlsKeyExchange;->init(Lorg/spongycastle/crypto/tls/TlsContext;)V
    ...
    iput-object v2, p0, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->serverCredentials:Lorg/spongycastle/crypto/tls/TlsCredentials;

    const/4 v2, 0x0

    iget-object v3, p0, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->serverCredentials:Lorg/spongycastle/crypto/tls/TlsCredentials;

    if-nez v3, :cond_9

    iget-object v3, p0, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->keyExchange:Lorg/spongycastle/crypto/tls/TlsKeyExchange;

    invoke-interface {v3}, Lorg/spongycastle/crypto/tls/TlsKeyExchange;->skipServerCredentials()V
    ...
    iget-object v4, p0, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->serverCredentials:Lorg/spongycastle/crypto/tls/TlsCredentials;

    invoke-interface {v3, v4}, Lorg/spongycastle/crypto/tls/TlsKeyExchange;->processServerCredentials(Lorg/spongycastle/crypto/tls/TlsCredentials;)V
    ...
    :cond_a
    iput-boolean v3, p0, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->allowCertificateStatus:Z

    :cond_b
    iget-boolean v4, p0, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->allowCertificateStatus:Z

    if-eqz v4, :cond_c

    iget-object v4, p0, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->tlsServer:Lorg/spongycastle/crypto/tls/TlsServer;

    invoke-interface {v4}, Lorg/spongycastle/crypto/tls/TlsServer;->getCertificateStatus()Lorg/spongycastle/crypto/tls/CertificateStatus;

    move-result-object v4

    if-eqz v4, :cond_c

    invoke-virtual {p0, v4}, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->sendCertificateStatusMessage(Lorg/spongycastle/crypto/tls/CertificateStatus;)V
    ...
    invoke-interface {v4}, Lorg/spongycastle/crypto/tls/TlsKeyExchange;->generateServerKeyExchange()[B

    move-result-object v4

    if-eqz v4, :cond_d

    invoke-virtual {p0, v4}, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->sendServerKeyExchangeMessage([B)V
    ...
    iget-object v3, p0, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->certificateRequest:Lorg/spongycastle/crypto/tls/CertificateRequest;
...
.method protected receiveCertificateVerifyMessage(Ljava/io/ByteArrayInputStream;)V
    ...
    iget-object v3, p0, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->prepareFinishHash:Lorg/spongycastle/crypto/tls/TlsHandshakeHash;

    invoke-virtual {v2}, Lorg/spongycastle/crypto/tls/SignatureAndHashAlgorithm;->getHash()S

    move-result v4

    invoke-interface {v3, v4}, Lorg/spongycastle/crypto/tls/TlsHandshakeHash;->getFinalHash(S)[B
    ...
    invoke-virtual {v4, v5}, Lorg/spongycastle/crypto/tls/Certificate;->getCertificateAt(I)Lorg/spongycastle/asn1/x509/Certificate;
    ...
    invoke-interface {v7, v8}, Lorg/spongycastle/crypto/tls/TlsSigner;->init(Lorg/spongycastle/crypto/tls/TlsContext;)V

    invoke-virtual {v0}, Lorg/spongycastle/crypto/tls/DigitallySigned;->getSignature()[B

    move-result-object v8

    invoke-interface {v7, v2, v8, v6, v3}, Lorg/spongycastle/crypto/tls/TlsSigner;->verifyRawSignature(Lorg/spongycastle/crypto/tls/SignatureAndHashAlgorithm;[BLorg/spongycastle/crypto/params/AsymmetricKeyParameter;[B)Z
    ...
    invoke-direct {v8, v1}, Lorg/spongycastle/crypto/tls/TlsFatalAlert;-><init>(S)V
    ...
    invoke-direct {v3, v1, v2}, Lorg/spongycastle/crypto/tls/TlsFatalAlert;-><init>(SLjava/lang/Throwable;)V
...
.method protected receiveClientHelloMessage(Ljava/io/ByteArrayInputStream;)V
    ...
    invoke-static {v5, p1}, Lorg/spongycastle/crypto/tls/TlsUtils;->readUint16Array(ILjava/io/InputStream;)[I

    move-result-object v5

    iput-object v5, p0, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->offeredCipherSuites:[I
    ...
    invoke-static {v5, p1}, Lorg/spongycastle/crypto/tls/TlsUtils;->readUint8Array(ILjava/io/InputStream;)[S

    move-result-object v2

    iput-object v2, p0, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->offeredCompressionMethods:[S
    ...
    iput-object v2, p0, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->clientExtensions:Ljava/util/Hashtable;
    ...
    iput-boolean v7, v2, Lorg/spongycastle/crypto/tls/SecurityParameters;->extendedMasterSecret:Z
    ...
    invoke-virtual {v2, v0}, Lorg/spongycastle/crypto/tls/AbstractTlsContext;->setClientVersion(Lorg/spongycastle/crypto/tls/ProtocolVersion;)V

    iget-object v2, p0, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->tlsServer:Lorg/spongycastle/crypto/tls/TlsServer;

    invoke-interface {v2, v0}, Lorg/spongycastle/crypto/tls/TlsServer;->notifyClientVersion(Lorg/spongycastle/crypto/tls/ProtocolVersion;)V
    ...
    invoke-interface {v2, v7}, Lorg/spongycastle/crypto/tls/TlsServer;->notifyFallback(Z)V
    ...
    invoke-interface {v2, v7}, Lorg/spongycastle/crypto/tls/TlsServer;->notifyOfferedCipherSuites([I)V

    iget-object v2, p0, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->tlsServer:Lorg/spongycastle/crypto/tls/TlsServer;

    iget-object v7, p0, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->offeredCompressionMethods:[S

    invoke-interface {v2, v7}, Lorg/spongycastle/crypto/tls/TlsServer;->notifyOfferedCompressionMethods([S)V

    iget-object v2, p0, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->offeredCipherSuites:[I

    const/16 v7, 0xff

    invoke-static {v2, v7}, Lorg/spongycastle/util/Arrays;->contains([II)Z

    move-result v2

    if-eqz v2, :cond_0

    iput-boolean v6, p0, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->secure_renegotiation:Z

    :cond_0
    iget-object v2, p0, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->clientExtensions:Ljava/util/Hashtable;

    sget-object v7, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->EXT_RenegotiationInfo:Ljava/lang/Integer;

    invoke-static {v2, v7}, Lorg/spongycastle/crypto/tls/TlsUtils;->getExtensionData(Ljava/util/Hashtable;Ljava/lang/Integer;)[B
    ...
    invoke-static {v2, v6}, Lorg/spongycastle/util/Arrays;->constantTimeAreEqual([B[B)Z
    ...
    invoke-interface {v2, v6}, Lorg/spongycastle/crypto/tls/TlsServer;->notifySecureRenegotiation(Z)V
    ...
    invoke-static {v2}, Lorg/spongycastle/crypto/tls/TlsExtensionsUtils;->getPaddingExtension(Ljava/util/Hashtable;)I

    iget-object v2, p0, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->tlsServer:Lorg/spongycastle/crypto/tls/TlsServer;

    iget-object v6, p0, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->clientExtensions:Ljava/util/Hashtable;

    invoke-interface {v2, v6}, Lorg/spongycastle/crypto/tls/TlsServer;->processClientExtensions(Ljava/util/Hashtable;)V
    ...
    invoke-direct {v6, v2}, Lorg/spongycastle/crypto/tls/TlsFatalAlert;-><init>(S)V
    ...
    invoke-direct {v2, v5}, Lorg/spongycastle/crypto/tls/TlsFatalAlert;-><init>(S)V
...
.method protected sendServerHelloMessage()V
    ...
    iput-object v5, p0, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->serverExtensions:Ljava/util/Hashtable;

    iget-boolean v5, p0, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->secure_renegotiation:Z
    ...
    invoke-static {v5, v7}, Lorg/spongycastle/crypto/tls/TlsUtils;->getExtensionData(Ljava/util/Hashtable;Ljava/lang/Integer;)[B
    ...
    iget-object v8, p0, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->serverExtensions:Ljava/util/Hashtable;

    invoke-static {v8}, Lorg/spongycastle/crypto/tls/TlsExtensionsUtils;->ensureExtensionsInitialised(Ljava/util/Hashtable;)Ljava/util/Hashtable;

    move-result-object v8

    iput-object v8, p0, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->serverExtensions:Ljava/util/Hashtable;
    ...
    iget-boolean v5, v5, Lorg/spongycastle/crypto/tls/SecurityParameters;->extendedMasterSecret:Z
    ...
    iput-boolean v7, v5, Lorg/spongycastle/crypto/tls/SecurityParameters;->encryptThenMAC:Z
    ...
    invoke-virtual {p0, v7, v8, v3}, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->processMaxFragmentLengthExtension(Ljava/util/Hashtable;Ljava/util/Hashtable;S)S

    move-result v7

    iput-short v7, v5, Lorg/spongycastle/crypto/tls/SecurityParameters;->maxFragmentLength:S
    ...
    iput-boolean v7, v5, Lorg/spongycastle/crypto/tls/SecurityParameters;->truncatedHMac:Z

    iget-boolean v5, p0, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->resumedSession:Z
    ...
    invoke-static {v5, v7, v3}, Lorg/spongycastle/crypto/tls/TlsUtils;->hasExpectedEmptyExtensionData(Ljava/util/Hashtable;Ljava/lang/Integer;S)Z
    ...
    iget-object v3, p0, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->serverExtensions:Ljava/util/Hashtable;

    invoke-static {v0, v3}, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->writeExtensions(Ljava/io/OutputStream;Ljava/util/Hashtable;)V
    ...
    invoke-static {v4, v5}, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->getPRFAlgorithm(Lorg/spongycastle/crypto/tls/TlsContext;I)I

    move-result v4

    iput v4, v3, Lorg/spongycastle/crypto/tls/SecurityParameters;->prfAlgorithm:I

    iget-object v3, p0, Lorg/spongycastle/crypto/tls/TlsServerProtocol;->securityParameters:Lorg/spongycastle/crypto/tls/SecurityParameters;

    const/16 v4, 0xc

    iput v4, v3, Lorg/spongycastle/crypto/tls/SecurityParameters;->verifyDataLength:I
    ...
    invoke-direct {v4, v3}, Lorg/spongycastle/crypto/tls/TlsFatalAlert;-><init>(S)V
