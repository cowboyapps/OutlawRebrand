...
.method private decodeBlock([BII)[B
    ...
    iget-object v1, v0, Lorg/spongycastle/crypto/encodings/ISO9796d1Encoding;->engine:Lorg/spongycastle/crypto/AsymmetricBlockCipher;
    ...
    iget v6, v0, Lorg/spongycastle/crypto/encodings/ISO9796d1Encoding;->bitSize:I
    ...
    sget-object v9, Lorg/spongycastle/crypto/encodings/ISO9796d1Encoding;->SIXTEEN:Ljava/math/BigInteger;

    invoke-virtual {v7, v9}, Ljava/math/BigInteger;->mod(Ljava/math/BigInteger;)Ljava/math/BigInteger;

    move-result-object v9

    sget-object v10, Lorg/spongycastle/crypto/encodings/ISO9796d1Encoding;->SIX:Ljava/math/BigInteger;
    ...
    :cond_0
    iget-object v9, v0, Lorg/spongycastle/crypto/encodings/ISO9796d1Encoding;->modulus:Ljava/math/BigInteger;

    invoke-virtual {v9, v7}, Ljava/math/BigInteger;->subtract(Ljava/math/BigInteger;)Ljava/math/BigInteger;

    move-result-object v9

    sget-object v10, Lorg/spongycastle/crypto/encodings/ISO9796d1Encoding;->SIXTEEN:Ljava/math/BigInteger;
    ...
    :goto_0
    invoke-static {v9}, Lorg/spongycastle/crypto/encodings/ISO9796d1Encoding;->convertOutputDecryptOnly(Ljava/math/BigInteger;)[B
    ...
    sget-object v12, Lorg/spongycastle/crypto/encodings/ISO9796d1Encoding;->inverse:[B
    ...
    sget-object v11, Lorg/spongycastle/crypto/encodings/ISO9796d1Encoding;->shadows:[B
    ...
    invoke-direct {v8, v11}, Lorg/spongycastle/crypto/InvalidCipherTextException;-><init>(Ljava/lang/String;)V
    ...
    iput v8, v0, Lorg/spongycastle/crypto/encodings/ISO9796d1Encoding;->padBits:I
    ...
    invoke-direct {v8, v10}, Lorg/spongycastle/crypto/InvalidCipherTextException;-><init>(Ljava/lang/String;)V
...
.method private encodeBlock([BII)[B
    ...
    iget v2, p0, Lorg/spongycastle/crypto/encodings/ISO9796d1Encoding;->padBits:I
    ...
    iget v5, p0, Lorg/spongycastle/crypto/encodings/ISO9796d1Encoding;->bitSize:I
    ...
    iget v6, p0, Lorg/spongycastle/crypto/encodings/ISO9796d1Encoding;->bitSize:I
    ...
    invoke-interface {v1, v0, v7, v3}, Lorg/spongycastle/crypto/AsymmetricBlockCipher;->processBlock([BII)[B
