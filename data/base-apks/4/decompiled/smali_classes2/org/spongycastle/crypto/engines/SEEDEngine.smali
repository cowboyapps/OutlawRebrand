...
.method private F(IIJ)J
    ...
    invoke-direct {p0, v1, p1, v2, p2}, Lorg/spongycastle/crypto/engines/SEEDEngine;->phaseCalc2(IIII)I

    move-result v3

    invoke-direct {p0, v1, p1, v2, p2}, Lorg/spongycastle/crypto/engines/SEEDEngine;->phaseCalc1(IIII)I
...
.method private createWorkingKey([B)[I
    ...
    invoke-direct {p0, p1, v3}, Lorg/spongycastle/crypto/engines/SEEDEngine;->bytesToLong([BI)J

    move-result-wide v3

    invoke-direct {p0, v1, v2}, Lorg/spongycastle/crypto/engines/SEEDEngine;->extractW0(J)I

    move-result v5

    invoke-direct {p0, v1, v2}, Lorg/spongycastle/crypto/engines/SEEDEngine;->extractW1(J)I
    ...
    sget-object v12, Lorg/spongycastle/crypto/engines/SEEDEngine;->KC:[I

    aget v12, v12, v9

    sub-int/2addr v11, v12

    invoke-direct {p0, v11}, Lorg/spongycastle/crypto/engines/SEEDEngine;->G(I)I
    ...
    invoke-direct {p0, v1, v2}, Lorg/spongycastle/crypto/engines/SEEDEngine;->rotateRight8(J)J
...
.method public processBlock([BI[BI)I
    ...
    invoke-direct {p0, p1, v2}, Lorg/spongycastle/crypto/engines/SEEDEngine;->bytesToLong([BI)J

    move-result-wide v2

    iget-boolean v4, p0, Lorg/spongycastle/crypto/engines/SEEDEngine;->forEncryption:Z
    ...
    iget-object v8, p0, Lorg/spongycastle/crypto/engines/SEEDEngine;->wKey:[I
    ...
    invoke-direct {p0, v8, v9, v2, v3}, Lorg/spongycastle/crypto/engines/SEEDEngine;->F(IIJ)J
    ...
    invoke-direct {p0, p3, v4, v2, v3}, Lorg/spongycastle/crypto/engines/SEEDEngine;->longToBytes([BIJ)V

    add-int/lit8 v4, p4, 0x8

    invoke-direct {p0, p3, v4, v0, v1}, Lorg/spongycastle/crypto/engines/SEEDEngine;->longToBytes([BIJ)V
