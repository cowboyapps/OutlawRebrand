...
.method public static keygen(Ljava/security/SecureRandom;[B[S)V
    ...
    invoke-static {p2, v0, v4}, Lorg/spongycastle/pqc/crypto/newhope/Poly;->getNoise([S[BB)V
    ...
    invoke-static {v4, v0, v5}, Lorg/spongycastle/pqc/crypto/newhope/Poly;->getNoise([S[BB)V

    invoke-static {v4}, Lorg/spongycastle/pqc/crypto/newhope/Poly;->toNTT([S)V

    new-array v5, v2, [S

    invoke-static {v3, p2, v5}, Lorg/spongycastle/pqc/crypto/newhope/Poly;->pointWise([S[S[S)V

    new-array v2, v2, [S

    invoke-static {v5, v4, v2}, Lorg/spongycastle/pqc/crypto/newhope/Poly;->add([S[S[S)V

    invoke-static {p1, v2, v1}, Lorg/spongycastle/pqc/crypto/newhope/NewHope;->encodeA([B[S[B)V
...
.method public static sharedA([B[S[B)V
    ...
    invoke-static {p1, v1, v0}, Lorg/spongycastle/pqc/crypto/newhope/Poly;->pointWise([S[S[S)V

    invoke-static {v0}, Lorg/spongycastle/pqc/crypto/newhope/Poly;->fromNTT([S)V

    invoke-static {p0, v0, v2}, Lorg/spongycastle/pqc/crypto/newhope/ErrorCorrection;->rec([B[S[S)V
...
.method public static sharedB(Ljava/security/SecureRandom;[B[B[B)V
    ...
    invoke-static {v4, v3}, Lorg/spongycastle/pqc/crypto/newhope/NewHope;->generateA([S[B)V
    ...
    invoke-static {v5, v2, v6}, Lorg/spongycastle/pqc/crypto/newhope/Poly;->getNoise([S[BB)V

    invoke-static {v5}, Lorg/spongycastle/pqc/crypto/newhope/Poly;->toNTT([S)V

    new-array v6, v0, [S

    const/4 v7, 0x1

    invoke-static {v6, v2, v7}, Lorg/spongycastle/pqc/crypto/newhope/Poly;->getNoise([S[BB)V

    invoke-static {v6}, Lorg/spongycastle/pqc/crypto/newhope/Poly;->toNTT([S)V

    new-array v7, v0, [S

    invoke-static {v4, v5, v7}, Lorg/spongycastle/pqc/crypto/newhope/Poly;->pointWise([S[S[S)V

    invoke-static {v7, v6, v7}, Lorg/spongycastle/pqc/crypto/newhope/Poly;->add([S[S[S)V

    new-array v8, v0, [S

    invoke-static {v1, v5, v8}, Lorg/spongycastle/pqc/crypto/newhope/Poly;->pointWise([S[S[S)V

    invoke-static {v8}, Lorg/spongycastle/pqc/crypto/newhope/Poly;->fromNTT([S)V

    new-array v9, v0, [S

    const/4 v10, 0x2

    invoke-static {v9, v2, v10}, Lorg/spongycastle/pqc/crypto/newhope/Poly;->getNoise([S[BB)V

    invoke-static {v8, v9, v8}, Lorg/spongycastle/pqc/crypto/newhope/Poly;->add([S[S[S)V

    new-array v0, v0, [S

    const/4 v10, 0x3

    invoke-static {v0, v8, v2, v10}, Lorg/spongycastle/pqc/crypto/newhope/ErrorCorrection;->helpRec([S[S[BB)V

    invoke-static {p2, v7, v0}, Lorg/spongycastle/pqc/crypto/newhope/NewHope;->encodeB([B[S[S)V

    invoke-static {p1, v8, v0}, Lorg/spongycastle/pqc/crypto/newhope/ErrorCorrection;->rec([B[S[S)V
